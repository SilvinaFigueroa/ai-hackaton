...
`}}}();rn.hash="e8fa488a0d466b5e40fdadc1e5227a57";const Gt=30,y1=5,k1=100,Ut=0,w1=0,x1=.99,jt=500,S1=300,M1=1e5,Qt=10,T1=1,qt=2,Wt=1,Jt=0;var T=(n=>(n.inferences="inferences",n.correctness="correctness",n.dimension="dimension",n))(T||{}),ge=(n=>(n.list="list",n.gallery="gallery",n))(ge||{}),he=(n=>(n.small="small",n.medium="medium",n.large="large",n))(he||{}),I=(n=>(n.primary="primary",n.reference="reference",n.corpus="corpus",n))(I||{}),_=(n=>(n.correct="correct",n.incorrect="incorrect",n.unknown="unknown",n))(_||{});const Xt=["#05fbff","#cb8afd"],Yt=["#00add0","#4500d9"],J="#a5a5a5",ue=J;function ea(n){return n.endsWith("/")?n.slice(0,-1):n}const o1=`${window.location.protocol}//${window.location.host}${ea(window.Config.basename)}`,zr=window.Config.platformVersion,na=o1+"/graphql",ta=async(n,t,a)=>{const r=await(await fetch(na,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query:n.text,variables:t})})).json();if(Array.isArray(r.errors))throw new Error(`Error fetching GraphQL query '${n.name}' with variables '${JSON.stringify(t)}': ${JSON.stringify(r.errors)}`);return r},Ie=new Ee.Environment({network:Ee.Network.create(ta),store:new Ee.Store(new Ee.RecordSource,{gcReleaseBufferSize:10})});function ln(n){return n.includes("PRIMARY")?$.primary:n.includes("CORPUS")?$.corpus:$.reference}function s1(n){const t=[],a=[],i=[];return n.forEach(r=>{const l=ln(r);l==$.primary?t.push(r):l==$.corpus?i.push(r):a.push(r)}),{primaryEventIds:t,referenceEventIds:a,corpusEventIds:i}}const Pe=10,ye="unknown",on=Un,sn=Gn,aa=n=>sn[n],ia=n=>on(n/Pe);var fe=(n=>(n.move="move",n.select="select",n))(fe||{}),c1=(n=>(n.default="default",n.highlight="highlight",n))(c1||{});const me=()=>hn()==="light"?Yt:Xt;function Rr(){const n=me();return{coloringStrategy:T.inferences,pointGroupVisibility:{[I.primary]:!0,[I.reference]:!0},pointGroupColors:{[I.primary]:n[0],[I.reference]:n[1],[I.corpus]:J},metric:{type:"drift",metric:"euclideanDistance"}}}function Hr(){const n=me();return{coloringStrategy:T.inferences,pointGroupVisibility:{[I.primary]:!0,[I.corpus]:!0},pointGroupColors:{[I.primary]:n[0],[I.corpus]:J},metric:{type:"retrieval",metric:"queryDistance"},clusterSort:{dir:"desc",column:"primaryMetricValue"}}}function Kr(){return{coloringStrategy:T.correctness,pointGroupVisibility:{[_.correct]:!0,[_.incorrect]:!0,[_.unknown]:!0},pointGroupColors:{[_.correct]:Ne.Discrete2.LightBlueOrange[0],[_.incorrect]:Ne.Discrete2.LightBlueOrange[1],[_.unknown]:ue},metric:{type:"performance",metric:"accuracyScore"},clusterSort:{dir:"asc",column:"primaryMetricValue"}}}const ra=n=>{const t={loading:!1,errorMessage:null,points:[],eventIdToDataMap:new Map,clusters:[],clusterSort:{dir:"desc",column:"driftRatio"},pointData:null,selectedEventIds:new Set,hoveredEventId:null,highlightedClusterId:null,selectedClusterId:null,canvasMode:"move",pointSizeScale:1,clusterColorMode:"default",coloringStrategy:T.inferences,inferencesVisibility:{primary:!0,reference:!0,corpus:!0},pointGroupVisibility:{[I.primary]:!0,[I.reference]:!0,[I.corpus]:!0},pointGroupColors:{[I.primary]:me()[0],[I.reference]:me()[1],[I.corpus]:J},eventIdToGroup:{},selectionDisplay:ge.gallery,selectionGridSize:he.large,dimension:null,dimensionMetadata:null,umapParameters:{minDist:Ut,nNeighbors:Gt,nSamples:jt},hdbscanParameters:{minClusterSize:Qt,clusterMinSamples:Wt,clusterSelectionEpsilon:Jt},clustersLoading:!1,metric:{type:"drift",metric:"euclideanDistance"},selectionSearchText:""},a=(i,r)=>({...t,...n,setInitialData:async({points:l,clusters:s,retrievals:d})=>{const c=r(),u=new Map,g=d.reduce((L,C)=>{const{queryId:w}=C;return L[w]?L[w].push(C):L[w]=[C],L},{});l.forEach(L=>{L={...L,retrievals:g[L.eventId]??[]},u.set(L.eventId,L)});const h=s.map(E1).sort(je(c.clusterSort));i({loading:!1,points:l,eventIdToDataMap:u,clusters:h,clustersLoading:!1,selectedEventIds:new Set,selectedClusterId:null,pointData:null,eventIdToGroup:re({points:l,coloringStrategy:c.coloringStrategy,pointsData:c.pointData??{},dimension:c.dimension||null,dimensionMetadata:c.dimensionMetadata})});const f=await sa(l.map(L=>L.eventId)).catch(()=>i({errorMessage:"Failed to load the point events"}));f&&i({pointData:f,clusters:h,clustersLoading:!1,eventIdToGroup:re({points:l,coloringStrategy:c.coloringStrategy,pointsData:f??{},dimension:c.dimension||null,dimensionMetadata:c.dimensionMetadata})})},setClusters:l=>{const s=r(),d=l.map(E1).sort(je(s.clusterSort));i({clusters:d,clustersLoading:!1,selectedClusterId:null,highlightedClusterId:null})},setClusterSort:l=>{const d=[...r().clusters].sort(je(l));i({clusterSort:l,clusters:d})},setSelectedEventIds:l=>i({selectedEventIds:l,selectionSearchText:""}),setHoveredEventId:l=>i({hoveredEventId:l}),setHighlightedClusterId:l=>i({highlightedClusterId:l}),setSelectedClusterId:l=>i({selectedClusterId:l,highlightedClusterId:null}),setPointSizeScale:l=>i({pointSizeScale:l}),setCanvasMode:l=>i({canvasMode:l}),setClusterColorMode:l=>i({clusterColorMode:l}),setColoringStrategy:l=>{const s=r();switch(i({coloringStrategy:l}),l){case T.correctness:i({pointGroupVisibility:{[_.correct]:!0,[_.incorrect]:!0,[_.unknown]:!0},pointGroupColors:{[_.correct]:Ne.Discrete2.LightBlueOrange[0],[_.incorrect]:Ne.Discrete2.LightBlueOrange[1],[_.unknown]:ue},dimension:null,dimensionMetadata:null,eventIdToGroup:re({points:s.points,coloringStrategy:l,pointsData:s.pointData??{},dimension:s.dimension||null,dimensionMetadata:s.dimensionMetadata})});break;case T.inferences:{i({pointGroupVisibility:{[I.primary]:!0,[I.reference]:!0,[I.corpus]:!0},pointGroupColors:{[I.primary]:me()[0],[I.reference]:me()[1],[I.corpus]:J},dimension:null,dimensionMetadata:null,eventIdToGroup:re({points:s.points,coloringStrategy:l,pointsData:s.pointData??{},dimension:s.dimension||null,dimensionMetadata:s.dimensionMetadata})});break}case T.dimension:{i({pointGroupVisibility:{unknown:!0},pointGroupColors:{unknown:ue},dimension:null,dimensionMetadata:null,eventIdToGroup:re({points:s.points,coloringStrategy:l,pointsData:s.pointData??{},dimension:s.dimension||null,dimensionMetadata:s.dimensionMetadata})});break}default:A()}},inferencesVisibility:{primary:!0,reference:!0,corpus:!0},setInferencesVisibility:l=>i({inferencesVisibility:l}),setPointGroupVisibility:l=>i({pointGroupVisibility:l}),selectionDisplay:ge.gallery,setSelectionDisplay:l=>i({selectionDisplay:l}),setSelectionGridSize:l=>i({selectionGridSize:l}),reset:()=>{i({points:[],clusters:[],selectedEventIds:new Set,selectedClusterId:null,eventIdToGroup:{}})},setDimension:async l=>{const s=r();i({dimension:l,dimensionMetadata:null});const d=await oa(l).catch(()=>i({errorMessage:"Failed to load the dimension metadata"}));if(d){if(i({dimensionMetadata:d}),d.categories&&d.categories.length){const c=d.categories.length,g=c<=sn.length?aa:h=>on(h/c);i({pointGroupVisibility:{...d.categories.reduce((h,f)=>({...h,[f]:!0}),{}),unknown:!0},pointGroupColors:{...d.categories.reduce((h,f,L)=>({...h,[f]:g(L)}),{}),unknown:ue},eventIdToGroup:re({points:s.points,coloringStrategy:s.coloringStrategy,pointsData:s.pointData??{},dimension:l,dimensionMetadata:d})})}else if(d.interval!==null){const c=cn(d.interval);i({pointGroupVisibility:{...c.reduce((u,g)=>({...u,[g.name]:!0}),{}),unknown:!0},pointGroupColors:{...c.reduce((u,g,h)=>({...u,[g.name]:ia(h)}),{}),unknown:ue},eventIdToGroup:re({points:s.points,coloringStrategy:s.coloringStrategy,pointsData:s.pointData??{},dimension:l,dimensionMetadata:d})})}}},setDimensionMetadata:l=>i({dimensionMetadata:l}),setUMAPParameters:l=>i({umapParameters:l}),setHDBSCANParameters:async l=>{const s=r();i({hdbscanParameters:l,clustersLoading:!0});const d=await ca({metric:s.metric,points:s.points,hdbscanParameters:l});s.setClusters(d)},getHDSCANParameters:()=>r().hdbscanParameters,getMetric:()=>r().metric,setErrorMessage:l=>i({errorMessage:l}),setLoading:l=>i({loading:l}),setMetric:async l=>{const s=r();i({metric:l,clustersLoading:!0});const d=await da({metric:l,clusters:s.clusters,hdbscanParameters:s.hdbscanParameters});s.setClusters(d)},setSelectionSearchText:l=>i({selectionSearchText:l})});return t1()(a1(a))},I1=new Intl.NumberFormat([],{maximumFractionDigits:2});function la({min:n,max:t}){return`${I1.format(n)} - ${I1.format(t)}`}function cn({min:n,max:t}){const i=(t-n)/Pe,r=[];for(let l=0;l<Pe;l++){const s=n+l*i,d=n+(l+1)*i;r.push({min:s,max:d,name:la({min:s,max:d})})}return r}function Ue({numericGroupIntervals:n,numericValue:t}){let a=ye,i=n.findIndex(r=>t>=r.min&&t<r.max);return i=i===-1?Pe-1:i,a=n[i].name,a}function re(n){const{points:t,coloringStrategy:a,pointsData:i,dimension:r,dimensionMetadata:l}=n,s={},d=t.map(c=>c.eventId);switch(a){case T.inferences:{const{primaryEventIds:c,referenceEventIds:u,corpusEventIds:g}=s1(d);c.forEach(h=>{s[h]=I.primary}),u.forEach(h=>{s[h]=I.reference}),g.forEach(h=>{s[h]=I.corpus});break}case T.correctness:{t.forEach(c=>{let u=_.unknown;const{predictionLabel:g,actualLabel:h}=c.eventMetadata;g!==null&&h!==null&&(u=g===h?_.correct:_.incorrect),s[c.eventId]=u});break}case T.dimension:{let c;l&&(l==null?void 0:l.interval)!==null&&(c=cn(l.interval));const u=(r==null?void 0:r.type)==="prediction"&&(r==null?void 0:r.dataType)==="categorical",g=(r==null?void 0:r.type)==="prediction"&&(r==null?void 0:r.dataType)==="numeric",h=(r==null?void 0:r.type)==="actual"&&(r==null?void 0:r.dataType)==="categorical",f=(r==null?void 0:r.type)==="actual"&&(r==null?void 0:r.dataType)==="numeric";t.forEach(L=>{let C=ye;const w=i[L.eventId];if(r!=null&&w!=null)if(u)C=w.eventMetadata.predictionLabel??ye;else if(g){if(c==null)throw new Error("Cannot color by prediction score without numeric group intervals");const x=w.eventMetadata.predictionScore;typeof x=="number"&&(C=Ue({numericGroupIntervals:c,numericValue:x}))}else if(f){if(c==null)throw new Error("Cannot color by actual score without numeric group intervals");const x=w.eventMetadata.actualScore;typeof x=="number"&&(C=Ue({numericGroupIntervals:c,numericValue:x}))}else if(h)C=w.eventMetadata.actualLabel??ye;else{const x=w.dimensions.find(F=>F.dimension.name===r.name);if(x!=null&&r.dataType==="categorical")C=x.value??ye;else if(x!=null&&r.dataType==="numeric"&&c!=null){const F=typeof(x==null?void 0:x.value)=="string"?parseFloat(x.value):null;typeof F=="number"&&(C=Ue({numericGroupIntervals:c,numericValue:F}))}}s[L.eventId]=C});break}default:A()}return s}async function oa(n){const t=await q.fetchQuery(Ie,rn,{id:n.id,getDimensionMinMax:n.dataType==="numeric",getDimensionCategories:n.dataType==="categorical"}).toPromise(),a=t==null?void 0:t.dimension;if(!n)throw new Error("Dimension not found");let i=null;return typeof(a==null?void 0:a.min)=="number"&&typeof(a==null?void 0:a.max)=="number"&&(i={min:a.min,max:a.max}),{interval:i,categories:(a==null?void 0:a.categories)??null}}async function sa(n){var u,g,h,f,L,C;const{primaryEventIds:t,referenceEventIds:a,corpusEventIds:i}=s1([...n]),r=await q.fetchQuery(Ie,an,{primaryEventIds:t,referenceEventIds:a,corpusEventIds:i}).toPromise(),l=((g=(u=r==null?void 0:r.model)==null?void 0:u.primaryInferences)==null?void 0:g.events)??[],s=((f=(h=r==null?void 0:r.model)==null?void 0:h.referenceInferences)==null?void 0:f.events)??[],d=((C=(L=r==null?void 0:r.model)==null?void 0:L.corpusInferences)==null?void 0:C.events)??[];return[...l,...s,...d].reduce((w,O)=>(w[O.id]=O,w),{})}async function ca({metric:n,points:t,hdbscanParameters:a}){const i=await q.fetchQuery(Ie,tn,{eventIds:t.map(r=>r.eventId),coordinates:t.map(r=>({x:r.position[0],y:r.position[1],z:r.position[2]})),fetchDataQualityMetric:n.type==="dataQuality",dataQualityMetricColumnName:n.type==="dataQuality"?n.dimension.name:null,fetchPerformanceMetric:n.type==="performance",performanceMetric:n.type==="performance"?n.metric:"accuracyScore",...a},{fetchPolicy:"network-only"}).toPromise();return(i==null?void 0:i.hdbscanClustering)??[]}async function da({metric:n,clusters:t,hdbscanParameters:a}){const i=await q.fetchQuery(Ie,nn,{clusters:t.map(r=>({id:r.id,eventIds:r.eventIds})),fetchDataQualityMetric:n.type==="dataQuality",dataQualityMetricColumnName:n.type==="dataQuality"?n.dimension.name:null,fetchPerformanceMetric:n.type==="performance",performanceMetric:n.type==="performance"?n.metric:"accuracyScore",...a},{fetchPolicy:"network-only"}).toPromise();return(i==null?void 0:i.clusters)??[]}const je=n=>(t,a)=>{const{dir:i,column:r}=n,l=i==="asc",s=t[r],d=a[r];return s==null?1:d==null?-1:s>d?l?1:-1:s<d?l?-1:1:0};function E1(n){let t=n.driftRatio,a=null;return n.dataQualityMetric?(t=n.dataQualityMetric.primaryValue,a=n.dataQualityMetric.referenceValue):n.performanceMetric?(t=n.performanceMetric.primaryValue,a=n.performanceMetric.referenceValue):n.primaryToCorpusRatio!=null&&(t=(n.primaryToCorpusRatio+1)/2*100),{...n,size:n.eventIds.length,primaryMetricValue:t,referenceMetricValue:a}}const d1=p.createContext(null);function Br({children:n,...t}){const a=p.useRef();return a.current||(a.current=ra(t)),e(d1.Provider,{value:a.current,children:n})}function v(n,t){const a=p.useContext(d1);if(!a)throw new Error("Missing PointCloudContext.Provider in the tree");return K1(a,n,t)}var K=(n=>(n.last_hour="Last Hour",n.last_day="Last Day",n.last_week="Last Week",n.last_month="Last Month",n.last_3_months="Last 3 Months",n.first_hour="First Hour",n.first_day="First Day",n.first_week="First Week",n.first_month="First Month",n.all="All",n))(K||{});const dn=p.createContext(null);function ua(){const n=p.useContext(dn);if(n===null)throw new Error("useTimeRange must be used within a TimeRangeProvider");return n}function ma(n,t){return p.useMemo(()=>{switch(n){case"Last Hour":{const i=ce(qn(t.end),{roundingMethod:"ceil"});return{start:Ye(i,1),end:i}}case"Last Day":{const i=ce(Qn(t.end),{roundingMethod:"ceil"});return{start:le(i,1),end:i}}case"Last Week":{const i=ce(De(t.end),{roundingMethod:"ceil"});return{start:le(i,7),end:i}}case"Last Month":{const i=ce(De(t.end),{roundingMethod:"ceil"});return{start:le(i,30),end:i}}case"Last 3 Months":{const i=ce(De(t.end),{roundingMethod:"ceil"});return{start:le(i,90),end:i}}case"First Hour":{const i=Xe(t.start);return{start:i,end:jn(i,1)}}case"First Day":{const i=de(t.start);return{start:i,end:_e(i,1)}}case"First Week":{const i=$e(t.start);return{start:i,end:_e(i,7)}}case"First Month":{const i=$e(t.start);return{start:i,end:_e(i,30)}}case"All":{const i=ce(De(t.end),{roundingMethod:"floor"});return{start:$e(t.start),end:i}}default:A()}},[n,t])}function Zr(n){const[t,a]=p.useState("Last Month"),i=ma(t,n.timeRangeBounds),r=p.useCallback(l=>{p.startTransition(()=>{a(l)})},[]);return e(dn.Provider,{value:{timeRange:i,timePreset:t,setTimePreset:r},children:n.children})}const un=p.createContext(null);function $r({children:n}){const[t,a]=kt({style:{zIndex:1e3}}),i=p.useCallback(l=>{t({variant:"danger",...l})},[t]),r=p.useCallback(l=>{t({variant:"success",...l})},[t]);return o(un.Provider,{value:{notify:t,notifyError:i,notifySuccess:r},children:[n,a]})}function mn(){const n=p.useContext(un);if(n===null)throw new Error("useGlobalNotification must be used within a NotificationProvider");return n}function Gr(){return mn().notifyError}function Ur(){return mn().notifySuccess}const pn="arize-phoenix-theme";function hn(){return localStorage.getItem(pn)==="light"?"light":"dark"}const u1=p.createContext(null);function U(){const n=p.useContext(u1);if(n===null)throw new Error("useTheme must be used within a ThemeProvider");return n}function jr(n){const[t,a]=p.useState(hn()),i=p.useCallback(r=>{localStorage.setItem(pn,r),a(r)},[]);return e(u1.Provider,{value:{theme:t,setTheme:i},children:n.children})}function Qr(n){return o("div",{role:"toolbar",css:m`
...
`;function ha(n){const{message:t="No Data"}=n;return e("tbody",{className:"is-empty",children:e("tr",{children:e("td",{colSpan:100,css:a=>m`
            text-align: center;
            padding: ${a.spacing.margin24}px ${a.spacing.margin24}px !important;
          `,children:t})})})}function vn({columns:n,data:t}){const a=Wn({columns:n,data:t,getCoreRowModel:Jn(),getPaginationRowModel:Xn(),getSortedRowModel:Yn()}),i=a.getRowModel().rows,l=i.length>0?e("tbody",{children:i.map(s=>e("tr",{children:s.getVisibleCells().map(d=>e("td",{children:C1(d.column.columnDef.cell,d.getContext())},d.id))},s.id))}):e(ha,{});return o(Oe,{children:[o("table",{css:Cn,children:[e("thead",{children:a.getHeaderGroups().map(s=>e("tr",{children:s.headers.map(d=>e("th",{colSpan:d.colSpan,children:d.isPlaceholder?null:e("div",{children:C1(d.column.columnDef.header,d.getContext())})},d.id))},s.id))}),l]}),o("div",{css:pa,children:[e(G,{variant:"default",size:"compact",onClick:a.previousPage,disabled:!a.getCanPreviousPage(),"aria-label":"Previous Page",icon:e(E,{svg:e(S.ArrowIosBackOutline,{})})}),e(G,{variant:"default",size:"compact",onClick:a.nextPage,disabled:!a.getCanNextPage(),"aria-label":"Next Page",icon:e(E,{svg:e(S.ArrowIosForwardOutline,{})})})]})]})}function bn(n){return Math.abs(n)<1e6?pe(",")(n):pe("0.2s")(n)}function Le(n){const t=Math.abs(n);return t===0?"0.00":t<.01?pe(".2e")(n):t<1e3?pe("0.2f")(n):pe("0.2s")(n)}function ga(n){return pe(".2f")(n)+"%"}function n1(n){return Number.isInteger(n)?bn(n):Le(n)}function Be(n){return t=>typeof t!="number"?"--":n(t)}const fa=Be(bn),yn=Be(Le),V1=Be(n1),La=Be(ga);function ke({getValue:n}){const t=n();if(!r1(t))throw new Error("IntCell only supports number or null values.");return e("span",{title:t!=null?String(t):"",children:yn(t)})}const Ca=m`
  float: right;
`;function va({getValue:n}){const t=n();if(!r1(t))throw new Error("IntCell only supports number or null values.");return e("span",{title:t!=null?String(t):"",css:Ca,children:fa(t)})}function ba({getValue:n}){const t=n();if(!r1(t))throw new Error("IntCell only supports number or null values.");return e("span",{title:t!=null?String(t):"",children:La(t)})}const _1=100;function ya(n){return n.length>_1?`${n.slice(0,_1)}...`:n}function Yr({getValue:n}){const t=n(),a=t!=null&&typeof t=="string"?ya(t):"--";return e("span",{title:String(t),children:a})}function e0({getValue:n}){const t=n(),a=t!=null&&typeof t=="string"?t:"--";return e("pre",{style:{whiteSpace:"pre-wrap"},children:a})}const ka=m`
  margin: 0;
  white-space: pre-wrap;
  word-wrap: break-word;
`;function F1(n,t){return n.length>t?`${n.slice(0,t)}...`:n}function wa({json:n,maxLength:t,space:a=0,disableTitle:i=!1}){const r=typeof t=="number",l=p.useMemo(()=>JSON.stringify(n,null,a),[n,a]),s=p.useMemo(()=>JSON.stringify(n,null,2),[n]),d=i?void 0:s;if(!$t(n))return console.warn("JSONText component received a non-object value",n),e("span",{title:d,children:String(n)});const c=n;if(Object.keys(c).length===0)return e("span",{title:d,children:"--"});if(Object.keys(c).length===1){const f=Object.keys(c)[0],L=c[f];if(typeof L=="string"){const C=r?F1(L,t):L;return e("span",{title:d,children:C})}}const u=r?F1(l,t):l;return e(r?"span":"pre",{title:d,css:r?void 0:ka,children:u})}const xa=100;function n0({getValue:n}){const t=n();return e(wa,{json:t,maxLength:xa})}function t0(n){const{data:t}=q.usePaginationFragment(fn,n.model),a=p.useMemo(()=>t.model.dimensions.edges.map(({dimension:r})=>({...r})),[t]),i=Y.useMemo(()=>[{header:"name",accessorKey:"name",cell:l=>e(Ln,{to:`dimensions/${l.row.original.id}`,children:l.renderValue()})},{header:"type",accessorKey:"type"},{header:"data type",accessorKey:"dataType"},{header:"cardinality",accessorKey:"cardinality",cell:va},{header:"% empty",accessorKey:"percentEmpty",cell:ba},{header:"min",accessorKey:"min",cell:ke},{header:"mean",accessorKey:"mean",cell:ke},{header:"max",accessorKey:"max",cell:ke},{header:"PSI",accessorKey:"psi",cell:ke}],[]);return e(vn,{columns:i,data:a})}const kn=function(){var n=[{defaultValue:50,kind:"LocalArgument",name:"count"},{defaultValue:null,kind:"LocalArgument",name:"cursor"},{defaultValue:null,kind:"LocalArgument",name:"endTime"},{defaultValue:null,kind:"LocalArgument",name:"startTime"}],t=[{kind:"Variable",name:"after",variableName:"cursor"},{kind:"Variable",name:"first",variableName:"count"}];return{fragment:{argumentDefinitions:n,kind:"Fragment",metadata:null,name:"ModelEmbeddingsTableEmbeddingDimensionsQuery",selections:[{args:[{kind:"Variable",name:"count",variableName:"count"},{kind:"Variable",name:"cursor",variableName:"cursor"},{kind:"Variable",name:"endTime",variableName:"endTime"},{kind:"Variable",name:"startTime",variableName:"startTime"}],kind:"FragmentSpread",name:"ModelEmbeddingsTable_embeddingDimensions"}],type:"Query",abstractKey:null},kind:"Request",operation:{argumentDefinitions:n,kind:"Operation",name:"ModelEmbeddingsTableEmbeddingDimensionsQuery",selections:[{alias:null,args:null,concreteType:"Model",kind:"LinkedField",name:"model",plural:!1,selections:[{alias:null,args:t,concreteType:"EmbeddingDimensionConnection",kind:"LinkedField",name:"embeddingDimensions",plural:!1,selections:[{alias:null,args:null,concreteType:"EmbeddingDimensionEdge",kind:"LinkedField",name:"edges",plural:!0,selections:[{alias:"embedding",args:null,concreteType:"EmbeddingDimension",kind:"LinkedField",name:"node",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"name",storageKey:null},{alias:"euclideanDistance",args:[{kind:"Literal",name:"metric",value:"euclideanDistance"},{fields:[{kind:"Variable",name:"end",variableName:"endTime"},{kind:"Variable",name:"start",variableName:"startTime"}],kind:"ObjectValue",name:"timeRange"}],kind:"ScalarField",name:"driftMetric",storageKey:null}],storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"cursor",storageKey:null},{alias:null,args:null,concreteType:"EmbeddingDimension",kind:"LinkedField",name:"node",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"__typename",storageKey:null}],storageKey:null}],storageKey:null},{alias:null,args:null,concreteType:"PageInfo",kind:"LinkedField",name:"pageInfo",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"endCursor",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"hasNextPage",storageKey:null}],storageKey:null}],storageKey:null},{alias:null,args:t,filters:null,handle:"connection",key:"ModelEmbeddingsTable_embeddingDimensions",kind:"LinkedHandle",name:"embeddingDimensions"}],storageKey:null}]},params:{cacheID:"d0057a41a1d9795383a58de89e72ad76",id:null,metadata:{},name:"ModelEmbeddingsTableEmbeddingDimensionsQuery",operationKind:"query",text:`query ModelEmbeddingsTableEmbeddingDimensionsQuery(
  $count: Int = 50
  $cursor: String = null
  $endTime: DateTime!
  $startTime: DateTime!
...
`}}}();kn.hash="fb7f125f75d1d33a555c16e198dbcbf8";const wn=function(){var n=["model","embeddingDimensions"];return{argumentDefinitions:[{defaultValue:50,kind:"LocalArgument",name:"count"},{defaultValue:null,kind:"LocalArgument",name:"cursor"},{defaultValue:null,kind:"LocalArgument",name:"endTime"},{defaultValue:null,kind:"LocalArgument",name:"startTime"}],kind:"Fragment",metadata:{connection:[{count:"count",cursor:"cursor",direction:"forward",path:n}],refetch:{connection:{forward:{count:"count",cursor:"cursor"},backward:null,path:n},fragmentPathInResult:[],operation:kn}},name:"ModelEmbeddingsTable_embeddingDimensions",selections:[{alias:null,args:null,concreteType:"Model",kind:"LinkedField",name:"model",plural:!1,selections:[{alias:"embeddingDimensions",args:null,concreteType:"EmbeddingDimensionConnection",kind:"LinkedField",name:"__ModelEmbeddingsTable_embeddingDimensions_connection",plural:!1,selections:[{alias:null,args:null,concreteType:"EmbeddingDimensionEdge",kind:"LinkedField",name:"edges",plural:!0,selections:[{alias:"embedding",args:null,concreteType:"EmbeddingDimension",kind:"LinkedField",name:"node",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"name",storageKey:null},{alias:"euclideanDistance",args:[{kind:"Literal",name:"metric",value:"euclideanDistance"},{fields:[{kind:"Variable",name:"end",variableName:"endTime"},{kind:"Variable",name:"start",variableName:"startTime"}],kind:"ObjectValue",name:"timeRange"}],kind:"ScalarField",name:"driftMetric",storageKey:null}],storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"cursor",storageKey:null},{alias:null,args:null,concreteType:"EmbeddingDimension",kind:"LinkedField",name:"node",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"__typename",storageKey:null}],storageKey:null}],storageKey:null},{alias:null,args:null,concreteType:"PageInfo",kind:"LinkedField",name:"pageInfo",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"endCursor",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"hasNextPage",storageKey:null}],storageKey:null}],storageKey:null}],storageKey:null}],type:"Query",abstractKey:null}}();wn.hash="fb7f125f75d1d33a555c16e198dbcbf8";const Sa=m`
  display: inline-flex;
  align-items: center;
  background: none;
  color: var(--ac-global-color-primary);
...
`;function a0(n){const{children:t,onClick:a}=n;return o("button",{css:Sa,onClick:a,children:[t," ",e(E,{svg:e(wt,{})})]})}function P({href:n,children:t}){return o("a",{href:n,target:"_blank",css:m`
        color: var(--ac-global-color-primary);
        text-decoration: none;
        position: relative;
        &:hover {
      ...
      `,rel:"noreferrer",children:[t,e(E,{svg:e(S.ExternalLinkOutline,{})})]})}const i0=()=>e("div",{css:m`
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
      ...
      `,children:e(j1,{isIndeterminate:!0,"aria-label":"loading"})}),Ma=({message:n})=>o("div",{css:m`
        display: flex;
        ...
        height: 100%;
        gap: var(--px-spacing-med);
      `,children:[e(j1,{isIndeterminate:!0,"aria-label":"loading"}),n!=null?e(b,{children:n}):null]});function r0(n){const{width:t="size-1250"}=n;return e(y,{width:t,backgroundColor:"light",borderStartWidth:"thin",borderStartColor:"dark",padding:"size-200",flex:"none",children:e(D,{direction:"column",alignItems:"end",justifyContent:"center",height:"100%",children:n.children})})}const Ta=2e3;function xn({text:n,size:t="compact",disabled:a=!1}){const[i,r]=p.useState(!1),l=p.useCallback(()=>{et(n),r(!0),setTimeout(()=>{r(!1)},Ta)},[n]);return e("div",{className:"copy-to-clipboard-button",children:o(R,{delay:0,offset:5,children:[e(G,{variant:"default",disabled:a,icon:e(E,{svg:i?e(S.Checkmark,{}):e(S.ClipboardCopy,{})}),size:t,onClick:l}),e(j,{children:"Copy"})]})})}function l0(n){const{data:t}=q.usePaginationFragment(wn,n.model),a=p.useMemo(()=>t.model.embeddingDimensions.edges.map(({embedding:r})=>({...r})),[t]),i=Y.useMemo(()=>[{header:"name",accessorKey:"name",cell:({row:l,renderValue:s})=>e(Ln,{to:`embeddings/${l.original.id}`,children:s()})},{header:"euclidean distance",accessorKey:"euclideanDistance",cell:ke}],[]);return e(vn,{columns:i,data:a})}const Sn=p.createContext(null),Ia=()=>{const n=p.useContext(Sn);if(n===null)throw new Error("useTimeSlice must be used within a TimeSliceProvider");return n},o0=({initialTimestamp:n,children:t})=>{const[a,i]=p.useState(n),r=l=>{p.startTransition(()=>{i(l)})};return e(Sn.Provider,{value:{selectedTimestamp:a,setSelectedTimestamp:r},children:t})},s0=n=>{const t=a=>({...n,columnVisibility:{metadata:!1},annotationColumnVisibility:{},setColumnVisibility:i=>{a({columnVisibility:i})},setAnnotationColumnVisibility:i=>{a({annotationColumnVisibility:i})}});return t1()(a1(t))};function Ea(){const n=v(a=>a.setPointSizeScale),t=v(a=>a.pointSizeScale);return o(Mt,{placement:"bottom left",children:[e(G,{variant:"default",size:"compact",icon:e(E,{svg:e(S.OptionsOutline,{})}),"aria-label":"Display Settings"}),e(St,{children:e(y,{padding:"size-100",children:e(D,{direction:"column",gap:"size-100",children:e(xt,{label:"Point Scale",minValue:0,maxValue:3,step:.1,value:t,onChange:n})})})})]})}const N1=m`
  display: flex;
  flex-direction: row;
  gap: var(--px-spacing-sm);
`;function Da(n){return typeof n=="string"&&n in fe}function Va(n){return o(Me,{defaultValue:n.mode,variant:"inline-button",size:"compact",onChange:t=>{if(Da(t))n.onChange(t);else throw new Error(`Unknown canvas mode: ${t}`)},children:[e(Z,{label:"Move",value:fe.move,children:o(R,{placement:"top",delay:0,offset:10,children:[e(X,{children:o("div",{css:N1,children:[e(E,{svg:e(S.MoveFilled,{})})," Move"]})}),e(j,{children:"Move around the canvas using orbital controls"})]})}),e(Z,{label:"Select",value:fe.select,children:o(R,{placement:"top",delay:0,offset:10,children:[e(X,{children:o("div",{css:N1,children:[e(E,{svg:e(S.LassoOutline,{})})," Select"]})}),e(j,{children:"Select points using the lasso tool"})]})})]})}function _a({radius:n}){const t=v(c=>c.eventIdToDataMap),a=v(c=>c.highlightedClusterId),i=v(c=>c.selectedClusterId),r=v(c=>c.clusters),{theme:l}=U(),s=v(c=>c.clusterColorMode),d=p.useMemo(()=>r.map(c=>{const{eventIds:u}=c,g=u.map(h=>{var L;return{position:(L=t.get(h))==null?void 0:L.position}}).filter(h=>h.position!==null);return{...c,data:g}}).filter(c=>c.data.length>0),[r,t]);return e(Oe,{children:d.map((c,u)=>{const g=Na({selected:c.id===i,highlighted:c.id===a,clusterColorMode:s});return e(nt,{data:c.data,opacity:g,wireframe:!0,pointRadius:n,color:Fa({theme:l,clusterColorMode:s,index:u,clusterCount:d.length})},`${c.id}__opacity_${String(g)}`)})})}function Fa({theme:n,clusterColorMode:t,index:a,clusterCount:i}){return t===c1.default?n==="dark"?"#999999":"#bbbbbb":Z1(a/i)}function Na({selected:n,highlighted:t,clusterColorMode:a}){return a===c1.highlight?1:n?.7:t?.5:0}const Pa=2;function Aa({pointRadius:n}){const t=v(u=>u.hoveredEventId),a=v(u=>u.pointSizeScale),i=v(u=>u.eventIdToDataMap),r=v(u=>u.pointGroupColors),l=v(u=>u.eventIdToGroup);if(t==null||i==null)return null;const s=i.get(t),d=l[t],c=r[d];return s==null?null:e(tt,{position:s.position,args:[n*Pa],scale:[a,a,a],children:e("meshMatcapMaterial",{color:c,opacity:.7,transparent:!0})})}const P1=1;function Oa(){const n=v(r=>r.hoveredEventId),t=v(r=>r.eventIdToDataMap),a=p.useRef(null);at((r,l)=>{a.current&&a.current.children.forEach(s=>s.children[0].material.uniforms.dashOffset.value-=l*5)});const i=p.useMemo(()=>{if(n==null)return[];const r=t.get(n);if(r==null)return[];const l=r.retrievals??[];return(l==null?void 0:l.length)===0?[]:l.map(d=>{const c=t.get(d.documentId);return c==null?null:[r.position,c.position]}).filter(d=>d!=null)},[t,n]);return e("group",{ref:a,children:i.map((r,l)=>o("group",{children:[e(v1,{start:r[0],end:r[1],color:16777215,opacity:1,transparent:!0,dashed:!0,dashScale:50,gapSize:20,linewidth:P1}),e(v1,{start:r[0],end:r[1],color:16777215,linewidth:P1/2,transparent:!0,opacity:.8})]},l))})}const za=.5,Ra=.5,Ha=100,A1=1.7;function O1(n,t){return typeof t=="function"?t(n):t}function Ka({primaryData:n,referenceData:t,corpusData:a,color:i,radius:r}){const l=v(M=>M.inferencesVisibility),s=v(M=>M.coloringStrategy),{theme:d}=U(),c=v(M=>M.setSelectedEventIds),u=v(M=>M.selectedEventIds),g=v(M=>M.setSelectedClusterId),h=v(M=>M.setHoveredEventId),f=v(M=>M.pointSizeScale),L=p.useMemo(()=>it(h,Ha),[h]),C=p.useMemo(()=>s!==T.inferences?"cube":"sphere",[s]),w=p.useMemo(()=>s!==T.inferences?"octahedron":"sphere",[s]),O=p.useMemo(()=>d==="dark"?rt(za):lt(Ra),[d]),x=p.useMemo(()=>typeof i=="function"?M=>O(i(M)):O(i),[i,O]),F=p.useCallback(M=>!u.has(M.metaData.id)&&u.size>0?O1(M,x):O1(M,i),[u,i,x]),te=l.reference&&t,Ce=l.corpus&&a,ae=p.useCallback(M=>{p.startTransition(()=>{c(new Set([M.metaData.id])),g(null)})},[g,c]),ie=p.useCallback(M=>{M==null||M.metaData==null||L(M.metaData.id)},[L]),ve=p.useCallback(()=>{L(null)},[L]);return o(Oe,{children:[l.primary?e(Ge,{data:n,pointProps:{color:F,radius:r,scale:f},onPointClicked:ae,onPointHovered:ie,onPointerLeave:ve}):null,te?e(Ge,{data:t,pointProps:{color:F,radius:r,size:r?r*A1:void 0,scale:f},onPointHovered:ie,onPointerLeave:ve,pointShape:C,onPointClicked:ae}):null,Ce?e(Ge,{data:a,pointProps:{color:F,radius:r,size:r?r*A1:void 0,scale:f},onPointHovered:ie,onPointerLeave:ve,pointShape:w,onPointClicked:ae}):null]})}const Ba=/\.(mp4|mov|webm|ogg)(\?|$)/i,Za=/\.(mp3|wav)(\?|$)/i;function $a(n){return Ba.test(n)}function Ga(n){return Za.test(n)}var oe=(n=>(n.square="square",n.circle="circle",n.diamond="diamond",n))(oe||{});const Ua=()=>e("svg",{width:"12px",height:"12px",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e("rect",{width:"12",height:"12",rx:"1",fill:"currentColor"})}),ja=()=>e("svg",{width:"12px",height:"12px",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e("circle",{cx:"6",cy:"6",r:"6",fill:"currentColor"})}),Qa=()=>e("svg",{width:"12px",height:"12px",viewBox:"0 0 12 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e("path",{d:"M6 0L12 6L6 12L0 6L6 0Z",fill:"currentColor"})});function Mn(n){const{shape:t,color:a}=n,i=p.useMemo(()=>{switch(t){case"square":return e(Ua,{});case"circle":return e(ja,{});case"diamond":return e(Qa,{});default:A()}},[t]);return e("i",{className:"shape-icon",style:{color:a},css:m`
        display: flex;
        flex-direction: row;
        align-items: center;
      `,"aria-hidden":!0,children:i})}function qa(n){const{rawData:t,linkToData:a,promptAndResponse:i,documentText:r}=n;return r!=null?"document":i!=null?"prompt_response":a!=null?$a(a)?"video":Ga(a)?"audio":"image":t!=null?"raw":"event_metadata"}function Wa(n,t){const{rawData:a}=t;switch(n){case"document":return null;case"prompt_response":return null;case"image":return a!=null?"raw":null;case"video":return a!=null?"raw":null;case"audio":return a!=null?"raw":null;case"raw":return"event_metadata";case"event_metadata":return null;default:A()}}function Ja(n){const{onClick:t,onMouseOver:a,onMouseOut:i,color:r,size:l,inferencesName:s,group:d}=n,c=qa(n),u=l==="large"?Wa(c,n):null;return o("div",{"data-testid":"event-item",role:"button","data-size":l,css:m`
        width: 100%;
        height: 100%;
      ...
      `,onClick:t,onMouseOver:a,onMouseOut:i,children:[o("div",{className:"event-item__preview-wrap","data-size":l,css:m`
          display: flex;
          flex-direction: row;
          flex: 1 1 auto;
          overflow: hidden;
        ...
        `,children:[e(z1,{previewType:c,...n}),u!=null&&e(z1,{previewType:u,...n})]}),l!=="small"&&e(r2,{color:r,group:d,inferencesName:s,showInferences:l==="large"})]})}function z1(n){const{previewType:t}=n;let a=null;switch(t){case"document":{a=e(t2,{...n});break}case"prompt_response":{a=e(n2,{...n});break}case"image":{a=e(Xa,{...n});break}case"video":{a=e(Ya,{...n});break}case"audio":{a=e(e2,{...n});break}case"raw":{a=e(a2,{...n});break}case"event_metadata":{a=e(i2,{...n});break}default:A()}return a}function Xa(n){return e("img",{src:n.linkToData||"[error] unexpected missing url",css:m`
        min-height: 0;
        // Maintain aspect ratio while having normalized height
        object-fit: contain;
        transition: background-color 0.2s ease-in-out;
        background-color: ${$1(.85,n.color)};
      `})}function Ya(n){return e("video",{src:n.linkToData||"[error] unexpected missing url",css:m`
        min-height: 0;
        // Maintain aspect ratio while having normalized height
        object-fit: contain;
        transition: background-color 0.2s ease-in-out;
        background-color: ${$1(.85,n.color)};
      `})}function e2(n){return e("audio",{src:n.linkToData||"[error] unexpected missing url",autoPlay:n.autoPlay,controls:!0})}function n2(n){var t,a;return o("div",{"data-size":n.size,css:m`
      ...
      `,children:[o("section",{children:[e("header",{children:"prompt"}),(t=n.promptAndResponse)==null?void 0:t.prompt]}),o("section",{children:[e("header",{children:"response"}),(a=n.promptAndResponse)==null?void 0:a.response]})]})}function t2(n){return e("p",{"data-size":n.size,css:m`
        flex: 1 1 auto;
        padding: var(--px-spacing-med);
      ...
      `,children:n.documentText})}function a2(n){return e("p",{"data-size":n.size,css:m`
        flex: 1 1 auto;
        padding: var(--px-spacing-med);
        margin-block-start: 0;
        margin-block-end: 0;
      ...
      `,children:n.rawData})}function i2(n){return o("dl",{css:m`
        margin: 0;
      ...
      `,children:[o("div",{children:[e("dt",{children:"prediction label"}),e("dd",{children:n.predictionLabel||"--"})]}),o("div",{children:[e("dt",{children:"actual label"}),e("dd",{children:n.actualLabel||"--"})]})]})}function r2({color:n,group:t,showInferences:a,inferencesName:i}){return o("footer",{css:m`
        display: flex;
        flex-direction: row;
        justify-content: space-between;
      ...
      `,children:[o("div",{css:m`
          display: flex;
          flex-direction: row;
          align-items: center;
          gap: var(--px-spacing-sm);
        `,children:[e(Mn,{shape:oe.circle,color:n}),t]}),a?e("div",{title:"the inferences the point belongs to",children:i}):null]})}const be=200,Ve=10,l2=new Rt,o2=()=>{const{getInferencesNameByRole:n}=Ke(),t=v(f=>f.hoveredEventId),a=v(f=>f.eventIdToDataMap),i=v(f=>f.pointData),r=v(f=>f.pointGroupColors),l=v(f=>f.eventIdToGroup);if(t==null||i==null||i==null)return null;const s=a.get(t),d=i[t];if(s==null||d==null)return null;const c=l[t],u=r[l[t]],g=ln(t),h=n(g);return e(ot,{position:s.position,pointerEvents:"none",zIndexRange:[0,1],calculatePosition:(f,L,C)=>{const w=l2.setFromMatrixPosition(f.matrixWorld);w.project(L);const O=C.width/2,x=C.height/2;return[Math.min(C.width-be-Ve,Math.max(0,w.x*O+O+Ve)),Math.min(C.height-be-Ve,Math.max(0,-(w.y*x)+x+Ve))]},children:e("div",{css:m`
          --grid-item-min-width: ${be}px;
          width: ${be}px;
          height: ${be}px;
          background-color: var(--ac-global-background-color-dark);
          border-radius: var(--ac-global-rounding-medium);
        `,children:e(Ja,{rawData:s.embeddingMetadata.rawData,linkToData:s.embeddingMetadata.linkToData,predictionLabel:s.eventMetadata.predictionLabel,actualLabel:s.eventMetadata.actualLabel,promptAndResponse:d.promptAndResponse,documentText:d.documentText,inferencesName:h,group:c,color:u,size:"medium",autoPlay:!0})})})},s2=300,c2=3,d2=.2,u2=function(){const{selectedTimestamp:t}=Ia(),a=v(c=>c.points),i=v(c=>c.hdbscanParameters),r=v(c=>c.umapParameters),[l,s,d]=p.useMemo(()=>{const{primaryEventIds:c,referenceEventIds:u,corpusEventIds:g}=s1(a.map(h=>h.eventId));return[c.length,u.length,g.length]},[a]);return t?o("section",{css:m`
        width: 300px;
        padding: var(--px-spacing-med);
      `,children:[o("dl",{css:Qe,children:[o("div",{children:[e("dt",{children:"Timestamp"}),e("dd",{children:e1(t)})]}),o("div",{children:[e("dt",{children:"primary points"}),e("dd",{children:l})]}),s>0?o("div",{children:[e("dt",{children:"reference points"}),e("dd",{children:s})]}):null,d>0?o("div",{children:[e("dt",{children:"corpus points"}),e("dd",{children:d})]}):null]}),e("br",{}),e(V,{level:4,weight:"heavy",children:"Clustering Parameters"}),o("dl",{css:Qe,children:[o("div",{children:[e("dt",{children:"min cluster size"}),e("dd",{children:i.minClusterSize})]}),o("div",{children:[e("dt",{children:"cluster min samples"}),e("dd",{children:i.clusterMinSamples})]}),o("div",{children:[e("dt",{children:"cluster selection epsilon"}),e("dd",{children:i.clusterSelectionEpsilon})]})]}),e("br",{}),e(V,{level:4,weight:"heavy",children:"UMAP Parameters"}),o("dl",{css:Qe,children:[o("div",{children:[e("dt",{children:"min distance"}),e("dd",{children:r.minDist})]}),o("div",{children:[e("dt",{children:"n neighbors"}),e("dd",{children:r.nNeighbors})]}),o("div",{children:[e("dt",{children:"n samples per inferences"}),e("dd",{children:r.nSamples})]})]})]}):null},Qe=m`
  margin: 0;
  padding: 0;
  div {
    display: flex;
...
`;function m2(){const n=v(a=>a.canvasMode),t=v(a=>a.setCanvasMode);return o("div",{css:m`
        position: absolute;
        ...
        align-items: center;
        gap: var(--px-spacing-med);
      `,children:[e(Va,{mode:n,onChange:t}),e(Ea,{}),e(p2,{})]})}function p2(){return o(R,{placement:"bottom left",delay:0,children:[e(G,{variant:"default",size:"compact",icon:e(E,{svg:e(Tt,{})}),"aria-label":"Information bout the point-cloud display"}),e(It,{title:"Point Cloud Summary",children:e(u2,{})})]})}function h2({children:n}){const{theme:t}=U();return e("div",{css:m`
        flex: 1 1 auto;
        height: 100%;
        position: relative;
        &[data-theme="dark"] {
      ...
      `,"data-theme":t,children:n})}function c0(){return o(h2,{children:[e(m2,{},"canvas-tools"),e(g2,{},"projection")]})}const g2=Y.memo(function(){const t=v(k=>k.points),a=v(k=>k.canvasMode),i=v(k=>k.setSelectedEventIds),r=v(k=>k.setSelectedClusterId),l=v(k=>k.pointGroupColors),s=v(k=>k.pointGroupVisibility),{theme:d}=U(),c=v(k=>k.inferencesVisibility),[u,g]=p.useState(!0),h=p.useMemo(()=>st(t.map(k=>k.position)),[t]),f=(h.maxX-h.minX+(h.maxY-h.minY))/2/s2,L=f*c2,C=a===fe.move,w=v(k=>k.eventIdToGroup),O=p.useCallback(k=>{const H=w[k.metaData.id]||"unknown";return l[H]||ue},[l,w]),x=p.useMemo(()=>t.filter(k=>k.eventId.includes("PRIMARY")),[t]),F=p.useMemo(()=>t.filter(k=>k.eventId.includes("REFERENCE")),[t]),te=p.useMemo(()=>t.filter(k=>k.eventId.includes("CORPUS")),[t]),Ce=p.useMemo(()=>x.filter(k=>{const H=w[k.eventId];return s[H]}),[x,w,s]),ae=p.useMemo(()=>!F||F.length===0?null:F.filter(k=>{const H=w[k.eventId];return s[H]}),[F,w,s]),ie=p.useMemo(()=>te.filter(k=>{const H=w[k.eventId];return s[H]}),[te,w,s]),ve=p.useMemo(()=>{const k=c.primary?Ce:[],H=c.reference?ae:[],Zn=c.corpus?ie:[];return[...k,...H||[],...Zn||[]]},[Ce,ae,ie,c]),M=ct(d1,l1,gt,u1);return e(ht,{camera:{position:[3,3,3]},children:o(M,{children:[e(dt,{autoRotate:u,autoRotateSpeed:2,enableRotate:C,enablePan:C,onEnd:()=>{g(!1)}}),o(ut,{bounds:h,boundsZoomPaddingFactor:d2,children:[e(mt,{points:ve,onChange:k=>{i(new Set(k.map(H=>H.metaData.id))),r(null)},enabled:a===fe.select}),e(pt,{size:(h.maxX-h.minX)/4,color:d=="dark"?"#fff":"#505050"}),e(Ka,{primaryData:Ce,referenceData:ae,corpusData:ie,color:O,radius:f}),e(_a,{radius:L}),e(o2,{}),e(Aa,{pointRadius:f}),e(Oa,{})]})]})})}),Tn=function(){var n=[{alias:null,args:null,concreteType:"Model",kind:"LinkedField",name:"model",plural:!1,selections:[{alias:null,args:null,concreteType:"DimensionConnection",kind:"LinkedField",name:"dimensions",plural:!1,selections:[{alias:null,args:null,concreteType:"DimensionEdge",kind:"LinkedField",name:"edges",plural:!0,selections:[{alias:null,args:null,concreteType:"Dimension",kind:"LinkedField",name:"node",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"id",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"name",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"type",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"dataType",storageKey:null}],storageKey:null}],storageKey:null}],storageKey:null}],storageKey:null}];return{fragment:{argumentDefinitions:[],kind:"Fragment",metadata:null,name:"DimensionPickerQuery",selections:n,type:"Query",abstractKey:null},kind:"Request",operation:{argumentDefinitions:[],kind:"Operation",name:"DimensionPickerQuery",selections:n},params:{cacheID:"56e356d226d322dabfd9db8010884e4f",id:null,metadata:{},name:"DimensionPickerQuery",operationKind:"query",text:`query DimensionPickerQuery {
  model {
    dimensions {
      edges {
        node {
...
`}}}();Tn.hash="747256fac1de97803ae6f96e3cb58d98";function f2(n){const{type:t}=n;let a="gray",i="";switch(t){case"feature":a="blue",i="FEA";break;case"tag":a="purple",i="TAG";break;case"prediction":a="white",i="PRE";break;case"actual":a="orange",i="ACT";break;default:A()}return e(i1,{color:a,"aria-label":t,title:"type",children:i})}const L2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"Model Dimension"}),e(ee,{children:e(b,{children:"A dimension is a feature, tag, prediction, or actual value that is associated with a model inference. Features represent inputs, tags represent metadata, predictions represent outputs, and actuals represent ground truth."})})]});function C2(n){const{selectedDimension:t,dimensions:a,onChange:i,isLoading:r,...l}=n;return e(Se,{...l,defaultSelectedKey:t?t.name:void 0,"aria-label":"Select a dimension",onSelectionChange:s=>{const d=a.find(c=>c.name===s);d&&p.startTransition(()=>i(d))},label:"Dimension",labelExtra:L2,isDisabled:r,placeholder:r?"Loading...":"Select a dimension...",children:a.map(s=>e(N,{textValue:s.name,children:o("div",{css:m`
              .ac-label {
                margin-right: var(--px-spacing-med);
              }
            `,children:[e(f2,{type:s.type}),s.name]})},s.name))})}function v2(n){const[t,a]=p.useState([]),[i,r]=p.useState(!0),{selectedDimension:l,onChange:s,...d}=n;return p.useEffect(()=>{q.fetchQuery(Ie,Tn,{},{fetchPolicy:"store-or-network"}).toPromise().then(c=>{const u=(c==null?void 0:c.model.dimensions.edges.map(g=>g.node))??[];a(u),r(!1)})},[]),e(C2,{...d,onChange:s,dimensions:t,label:"Dimension",selectedDimension:l,isLoading:i})}function b2(n){return typeof n=="string"&&n in T}const y2=Object.values(T),k2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"Coloring Strategy"}),e(ee,{children:e(b,{children:"The way in which inference point is colored. Each point in the point-cloud represents a model inference. These inferences can be colored by a particular attribute (such as inferences and dimension) or by a performance value such as correctness (predicted value equals the actual value)"})})]});function w2(n){const{strategy:t,onChange:a}=n;return e(Se,{defaultSelectedKey:t,"aria-label":"Coloring strategy",onSelectionChange:i=>{b2(i)&&a(i)},label:"Color By",labelExtra:k2,children:y2.map(i=>e(N,{children:i},i))})}const x2=m`
  display: flex;
  flex-direction: row;
  gap: var(--px-flex-gap-sm);
  align-items: center;
`;function Fe(n){const{name:t,checked:a,onChange:i,color:r,iconShape:l=oe.circle}=n;return o("label",{css:x2,children:[e("input",{type:"checkbox",checked:a,name:t,onChange:i}),e(Mn,{shape:l,color:r}),t]},t)}function S2({hasReference:n,hasCorpus:t}){const a=v(f=>f.inferencesVisibility),i=v(f=>f.setInferencesVisibility),r=v(f=>f.coloringStrategy),l=p.useCallback(f=>{const{name:L,checked:C}=f.target;i({...a,[L]:C})},[a,i]),s=zt(),d=p.useMemo(()=>{switch(r){case T.inferences:return s[0];case T.correctness:case T.dimension:return J;default:A()}},[r,s]),c=p.useMemo(()=>{switch(r){case T.inferences:return s[1];case T.correctness:case T.dimension:return J;default:A()}},[r,s]),u=J,g=r===T.inferences?oe.circle:oe.square,h=r===T.inferences?oe.circle:oe.diamond;return o("form",{css:m`
        display: flex;
        flex-direction: column;
        padding: var(--px-spacing-med);
      `,children:[e(Fe,{checked:a.primary,name:"primary",color:d,onChange:l}),n?e(Fe,{checked:a.reference,name:"reference",onChange:l,color:c,iconShape:g}):null,t?e(Fe,{checked:a.corpus,name:"corpus",onChange:l,color:u,iconShape:h}):null]})}function M2(){const n=v(l=>l.pointGroupVisibility),t=v(l=>l.setPointGroupVisibility),a=v(l=>l.pointGroupColors),i=p.useMemo(()=>Object.keys(n),[n]),r=p.useCallback(l=>{const{name:s,checked:d}=l.target;t({...n,[s]:d})},[n,t]);return o("form",{css:m`
        display: flex;
        flex-direction: column;
      `,children:[e(T2,{}),e("div",{css:m`
          padding: var(--px-spacing-med);
        `,children:i.map(l=>{const s=n[l],d=a[l];return e(Fe,{name:l,checked:s,color:d,onChange:r},l)})})]})}function T2(){const n=v(l=>l.pointGroupVisibility),t=v(l=>l.setPointGroupVisibility),a=v(l=>l.coloringStrategy),i=p.useMemo(()=>Object.values(n).every(l=>!l),[n]),r=p.useCallback(l=>{const{checked:s}=l.target,d=Object.keys(n).reduce((c,u)=>(c[u]=s,c),{});t(d)},[n,t]);return o("label",{css:()=>m`
        display: flex;
        flex-direction: row;
        gap: var(--px-flex-gap-sm);
        padding: var(--px-spacing-sm) var(--px-spacing-med);
        background-color: var(--ac-global-background-color-light);
      `,children:[e("input",{type:"checkbox",checked:!i,onChange:r}),`${a}`]})}function d0(){const{referenceInferences:n,corpusInferences:t}=Ke(),a=v(h=>h.coloringStrategy),i=v(h=>h.setColoringStrategy),r=v(h=>h.dimension),l=v(h=>h.dimensionMetadata),s=v(h=>h.setDimension),d=n!=null||t!=null,c=a===T.dimension&&r==null,u=a===T.dimension&&r!=null&&l==null,g=a!==T.inferences&&!c&&!u;return o("section",{css:m`
        & > .ac-form {
      ...
      `,children:[e(Te,{children:o(Oe,{children:[e(w2,{strategy:a,onChange:i}),a===T.dimension?e(v2,{selectedDimension:null,onChange:h=>{s(h)}}):null]})}),d?e(S2,{hasReference:n!=null,hasCorpus:t!=null}):null,g?e(M2,{}):null,c?e(Et,{variant:"info",showIcon:!1,children:"Please select a dimension to color the point cloud by"}):null,u?e("div",{css:m`
            padding: var(--px-spacing-med);
            min-height: 100px;
            display: flex;
            flex-direction: column;
            justify-content: center;
            align-items: center;
          `,children:e(Ma,{message:"Calculating point colors"})}):null]})}function I2(n){return typeof n=="string"&&n in ge}function u0(n){return o(Me,{defaultValue:n.mode,variant:"inline-button",onChange:t=>{if(I2(t))n.onChange(t);else throw new Error(`Unknown view mode: ${t}`)},children:[e(Z,{label:"List",value:ge.list,children:e(E,{svg:e(S.ListOutline,{})})}),e(Z,{label:"Grid",value:ge.gallery,children:e(E,{svg:e(S.Grid,{})})})]})}function m0(n){const{driftRatio:t,primaryToCorpusRatio:a,clusterId:i,isSelected:r,onClick:l,onMouseEnter:s,onMouseLeave:d,metricName:c,primaryMetricValue:u,referenceMetricValue:g,hideReference:h}=n,{percentage:f,comparisonInferencesRole:L}=p.useMemo(()=>typeof a=="number"?{percentage:(a+1)/2*100,comparisonInferencesRole:$.corpus}:typeof t=="number"?{percentage:(t+1)/2*100,comparisonInferencesRole:$.reference}:{percentage:100,comparisonInferencesRole:null},[t,a]);return o("div",{css:m`
      ...
      `,className:r?"is-selected":"",role:"button",onClick:l,onMouseEnter:s,onMouseLeave:d,children:[o("div",{css:m`
          padding: var(--ac-global-dimension-static-size-100);
          display: flex;
          flex-direction: row;
          justify-content: space-between;
          align-items: center;
        `,children:[e(D,{"data-testid":"cluster-description",direction:"column",gap:"size-50",alignItems:"start",children:o(D,{direction:"column",alignItems:"start",children:[e(V,{level:3,children:`Cluster ${i}`}),e(b,{color:"text-700",textSize:"small",children:`${n.numPoints} points`})]})}),o("div",{"data-testid":"cluster-metric",css:m`
            display: flex;
            flex-direction: column;
            align-items: end;
          `,children:[e(b,{color:"text-700",textSize:"small",children:c}),e(b,{color:"text-900",textSize:"medium",children:V1(u)}),h?null:e(b,{color:"designationPurple",textSize:"small",children:V1(g)})]})]}),e(E2,{primaryPercentage:f,comparisonInferencesRole:L})]})}function E2({primaryPercentage:n,comparisonInferencesRole:t}){return o("div",{"data-testid":"inferences-distribution",css:m`
        display: flex;
        flex-direction: row;
      `,children:[e("div",{"data-testid":"primary-distribution",css:m`
          ...
          width: ${n}%;
        `}),e("div",{"data-testid":"reference-distribution","data-reference-inferences-role":`${t??"none"}`,css:m`
          ...
          height: var(--px-gradient-bar-height);
          width: ${100-n}%;
        `})]})}const D2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"UMAP N Neighbors"}),e(ee,{children:e(b,{children:"This parameter controls how UMAP balances local versus global structure in the data. It does this by constraining the size of the local neighborhood UMAP will look at when attempting to learn the manifold structure of the data. This means that low values of n_neighbors will force UMAP to concentrate on very local structure (potentially to the detriment of the big picture), while large values will push UMAP to look at larger neighborhoods of each point when estimating the manifold structure of the data, losing fine detail structure for the sake of getting the broader of the data."})}),e("footer",{children:e(P,{href:"https://umap-learn.readthedocs.io/en/latest/parameters.html#n-neighbors",children:"View UMAP documentation"})})]}),V2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"UMAP Minimum Distance"}),e(ee,{children:e(b,{children:"The min_dist parameter controls how tightly UMAP is allowed to pack points together. It, quite literally, provides the minimum distance apart that points are allowed to be in the low dimensional representation. This means that low values of min_dist will result in clumpier embeddings. This can be useful if you are interested in clustering, or in finer topological structure. Larger values of min_dist will prevent UMAP from packing points together and will focus on the preservation of the broad topological structure instead."})}),e("footer",{children:e(P,{href:"https://umap-learn.readthedocs.io/en/latest/parameters.html#min-dist",children:"View UMAP documentation"})})]}),_2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"Number of Samples"}),o(ee,{children:[e(b,{elementType:"p",children:"Determines the number of samples from each inferences to use when projecting the point cloud using UMAP. This number is per-inferences so a value of 500 means that the point cloud will contain up to 1000 points."}),e("br",{}),e(b,{elementType:"p",children:"For best results keep this value low until you have identified a sample that you would like to analyze in more detail."})]})]});function p0(){const n=v(c=>c.umapParameters),t=v(c=>c.setUMAPParameters),{handleSubmit:a,control:i,setError:r,formState:{isDirty:l,isValid:s}}=ze({reValidateMode:"onChange",defaultValues:n}),d=p.useCallback(c=>{const u=parseFloat(c.minDist);if(u<w1||u>x1){r("minDist",{message:`must be between ${w1} and ${x1}`});return}t({minDist:u,nNeighbors:parseInt(c.nNeighbors,10),nSamples:parseInt(c.nSamples,10)})},[t,r]);return e("section",{css:m`
        & > .ac-form {
          padding: var(--px-spacing-med) var(--px-spacing-med) 0
            var(--px-spacing-med);
        }
      `,children:o(Te,{onSubmit:a(d),children:[e(z,{name:"minDist",control:i,rules:{required:"field is required"},render:({field:{onChange:c,onBlur:u,value:g},fieldState:{invalid:h,error:f}})=>e(B,{label:"min distance",labelExtra:V2,type:"number",description:"how tightly to pack points",errorMessage:f==null?void 0:f.message,validationState:h?"invalid":"valid",onChange:L=>c(parseFloat(L)),onBlur:u,value:g.toString()})}),e(z,{name:"nNeighbors",control:i,rules:{required:"n neighbors is required",min:{value:y1,message:`greater than or equal to ${y1}`},max:{value:k1,message:`less than or equal to ${k1}`}},render:({field:c,fieldState:{invalid:u,error:g}})=>e(B,{label:"n neighbors",labelExtra:D2,type:"number",step:"0.01",description:"balances local versus global structure",errorMessage:g==null?void 0:g.message,validationState:u?"invalid":"valid",...c,value:c.value})}),e(z,{name:"nSamples",control:i,rules:{required:"n samples is required",max:{value:M1,message:`must be below ${M1}`},min:{value:S1,message:`must be above ${S1}`}},render:({field:{onChange:c,onBlur:u,value:g},fieldState:{invalid:h,error:f}})=>e(B,{label:"n samples",labelExtra:_2,defaultValue:"500",type:"number",description:"number of points to use per inferences",errorMessage:f==null?void 0:f.message,validationState:h?"invalid":"valid",onChange:L=>c(parseInt(L,10)),onBlur:u,value:g.toString()})}),e("div",{css:m`
            display: flex;
            flex-direction: row;
            justify-content: flex-end;
            margin-top: var(--px-spacing-med);
          `,children:e(G,{variant:l?"primary":"default",type:"submit",isDisabled:!s,css:m`
              width: 100%;
            `,children:"Apply UMAP Parameters"})})]})})}const qe=2147483647,F2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"Minimum Cluster Size"}),e(ee,{children:e(b,{elementType:"p",children:"The primary parameter to effect the resulting clustering is min_cluster_size. Ideally this is a relatively intuitive parameter to select – set it to the smallest size grouping that you wish to consider a cluster."})}),e("footer",{children:e(P,{href:"https://hdbscan.readthedocs.io/en/latest/parameter_selection.html#selecting-min-cluster-size",children:"View HDBSCAN documentation"})})]}),N2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"Minimum Samples"}),e(ee,{children:e(b,{elementType:"p",children:"The simplest intuition for what min_samples does is provide a measure of how conservative you want you clustering to be. The larger the value of min_samples you provide, the more conservative the clustering – more points will be declared as noise, and clusters will be restricted to progressively more dense areas."})}),e("footer",{children:e(P,{href:"https://hdbscan.readthedocs.io/en/latest/parameter_selection.html#selecting-min-samples",children:"View HDBSCAN documentation"})})]}),P2=o(ne,{children:[e(V,{weight:"heavy",level:4,children:"Cluster Selection Epsilon"}),e(ee,{children:e(b,{elementType:"p",children:"In some cases, we want to choose a small min_cluster_size because even groups of few points might be of interest to us. However, if our data set also contains partitions with high concentrations of objects, this parameter setting can result in a large number of micro-clusters. Selecting a value for cluster_selection_epsilon helps us to merge clusters in these regions. Or in other words, it ensures that clusters below the given threshold are not split up any further."})}),e("footer",{children:e(P,{href:"https://hdbscan.readthedocs.io/en/latest/parameter_selection.html#selecting-cluster-selection-epsilon",children:"View HDBSCAN documentation"})})]});function h0(){const n=v(u=>u.hdbscanParameters),t=v(u=>u.setHDBSCANParameters),a=v(u=>u.clustersLoading),{control:i,handleSubmit:r,formState:{isDirty:l,isValid:s},reset:d}=ze({defaultValues:n}),c=p.useCallback(u=>{const g={minClusterSize:parseInt(u.minClusterSize,10),clusterMinSamples:parseInt(u.clusterMinSamples,10),clusterSelectionEpsilon:parseFloat(u.clusterSelectionEpsilon)};t(g),d(g)},[t,d]);return e("section",{css:m`
        & > .ac-form {
          padding: var(--px-spacing-med) var(--px-spacing-med) 0
            var(--px-spacing-med);
        }
      `,children:o(Te,{onSubmit:r(c),children:[e(z,{name:"minClusterSize",control:i,rules:{required:"field is required",min:{value:qt,message:"must be greater than 1"},max:{value:qe,message:"must be less than 2,147,483,647"}},render:({field:{onChange:u,onBlur:g,value:h},fieldState:{invalid:f,error:L}})=>e(B,{label:"min cluster size",labelExtra:F2,type:"number",description:"the smallest size for a cluster",errorMessage:L==null?void 0:L.message,validationState:f?"invalid":"valid",onChange:C=>u(parseInt(C,10)),onBlur:g,value:h.toString()})}),e(z,{name:"clusterMinSamples",control:i,rules:{required:"field is required",min:{value:T1,message:`must be greater than ${T1}`},max:{value:qe,message:"must be less than 2,147,483,647"}},render:({field:{onBlur:u,onChange:g,value:h},fieldState:{invalid:f,error:L}})=>e(B,{label:"cluster minimum samples",labelExtra:N2,type:"number",description:"determines if a point is a core point",errorMessage:L==null?void 0:L.message,validationState:f?"invalid":"valid",onChange:C=>g(parseInt(C,10)),onBlur:u,value:h.toString()})}),e(z,{name:"clusterSelectionEpsilon",control:i,rules:{required:"field is required",min:{value:0,message:"must be a non-negative number"},max:{value:qe,message:"must be less than 2,147,483,647"}},render:({field:{onBlur:u,onChange:g,value:h},fieldState:{invalid:f,error:L}})=>e(B,{label:"cluster selection epsilon",labelExtra:P2,type:"number",description:"A distance threshold",errorMessage:L==null?void 0:L.message,validationState:f?"invalid":"valid",onChange:C=>g(parseInt(C,10)),onBlur:u,value:h.toString()})}),e("div",{css:m`
            display: flex;
            flex-direction: row;
            justify-content: flex-end;
            margin-top: var(--px-spacing-med);
          `,children:e(G,{variant:l?"primary":"default",type:"submit",isDisabled:!s,loading:a,css:m`
              width: 100%;
            `,children:a?"Applying parameters":"Apply Clustering Config"})})]})})}const g0=m`
...
`;function L0(n){return e("div",{css:m`
        background-color: var(--ac-global-color-grey-200);
        ...
        gap: var(--px-spacing-sm);
        min-width: 200px;
      `,children:n.children})}function C0(n){return o("div",{css:m`
        display: flex;
        flex-direction: row;
        justify-content: space-between;
      `,children:[o("div",{css:m`
          ...
          gap: var(--px-spacing-med);
          align-items: center;
        `,children:[e(O2,{color:n.color,shape:n.shape??"line"}),e(b,{children:n.name})]}),e(b,{children:n.value})]})}function v0(){return e("div",{css:m`
        height: 1px;
        background-color: var(--ac-global-color-grey-300);
        width: 100%;
      `})}const A2=n=>{if(n==="line")return m`
      width: 8px;
      height: 2px;
    ...
    `;if(n==="square")return m`
      width: 8px;
      height: 8px;
    `};function O2({color:n,shape:t="line"}){return e("div",{css:m(A2(t),m`
          background-color: ${n};
          flex: none;
        `)})}const b0={dataKey:"timestamp",stroke:"var(--ac-global-colo-grey-400)",style:{fill:"var(--ac-global-text-color-700)"},scale:"time",type:"number",domain:["auto","auto"],padding:"gap"},y0={stroke:"var(--ac-global-color-grey-900)",label:{value:"▼",position:"top",style:{fill:"#fabe32",fontSize:Q1.typography.sizes.small.fontSize}}},k0={cursor:{fill:"var(--ac-global-color-grey-300)"}},we=60,xe=we*24,We=2*xe;function w0(n){const{start:t,end:a}=n,i=Math.floor((a.valueOf()-t.valueOf())/1e3/60/60);return i<=1?{evaluationWindowMinutes:1,samplingIntervalMinutes:1}:i<=24?{evaluationWindowMinutes:we,samplingIntervalMinutes:we}:{evaluationWindowMinutes:xe,samplingIntervalMinutes:xe}}function x0(n){const{start:t,end:a}=n,i=Math.floor((a.valueOf()-t.valueOf())/1e3/60/60);return i<=1?{evaluationWindowMinutes:We,samplingIntervalMinutes:1}:i<=24?{evaluationWindowMinutes:We,samplingIntervalMinutes:we}:{evaluationWindowMinutes:We,samplingIntervalMinutes:xe}}function z2(n){let t;return n<we?t="%H:%M %p":n<xe?t="%x %H:%M %p":t="%-m/%-d",t}function S0(n){const t=n.samplingIntervalMinutes;return p.useMemo(()=>Ae(z2(t)),[t])}const R2=Object.freeze({blue100:"#A4C7E0",blue200:"#7EB0D2",blue300:"#5899C5",blue400:"#3C80AE",blue500:"#2F6488",orange100:"#FECC95",orange200:"#FDB462",orange300:"#FC9C31",orange400:"#F78403",orange500:"#C46903",purple100:"#BEBADA",purple200:"#9E98C8",purple300:"#7F77B6",purple400:"#6157A3",purple500:"#4D4581",pink100:"#FCCDE5",pink200:"#F99FCD",pink300:"#F66FB4",pink400:"#F33F9B",pink500:"#F10E82",gray100:"#f0f0f0",gray200:"#d9d9d9",gray300:"#bdbdbd",gray400:"#969696",gray500:"#737373",gray600:"#525252",gray700:"#252525",default:"#ffffff",primary:"#9efcfd",reference:"#baa1f9"}),H2=Object.freeze({default:"#000000",blue100:"#2F6488",blue200:"#3C80AE",blue300:"#5899C5",blue400:"#7EB0D2",blue500:"#A4C7E0",orange100:"#C46903",orange200:"#F78403",orange300:"#FC9C31",orange400:"#FDB462",orange500:"#FECC95",purple100:"#4D4581",purple200:"#6157A3",purple300:"#7F77B6",purple400:"#9E98C8",purple500:"#BEBADA",pink100:"#F10E82",pink200:"#F33F9B",pink300:"#F66FB4",pink400:"#F99FCD",pink500:"#FCCDE5",gray100:"#252525",gray200:"#525252",gray300:"#737373",gray400:"#969696",gray500:"#bdbdbd",gray600:"#d9d9d9",gray700:"#f0f0f0",primary:"#00add0",reference:"#4500d9"}),M0=()=>{const{theme:n}=U();return p.useMemo(()=>n==="dark"?R2:H2,[n])};function T0(n){switch(n.__typename){case"NominalBin":return n.name;case"IntervalBin":return`${n1(n.range.start)} - ${n1(n.range.end)}`;case"MissingValueBin":return"(empty)";case"%other":throw new Error("Unexpected bin type %other");default:A()}}function K2(n){return typeof n=="string"&&n in he}function I0(n){return o(Me,{defaultValue:n.size,variant:"inline-button",onChange:t=>{if(K2(t))n.onChange(t);else throw new Error(`Unknown grid size: ${t}`)},children:[e(Z,{label:"Small",value:he.small,children:"S"}),e(Z,{label:"Medium",value:he.medium,children:"M"}),e(Z,{label:"Large",value:he.large,children:"L"})]})}function E0(n){const{message:t,...a}=n;return e("div",{css:m`
        width: 100%;
        display: flex;
        justify-content: center;
      `,children:o("div",{css:i=>m`
          margin: ${i.spacing.margin24}px;
          display: flex;
          flex-direction: column;
          align-items: center;
        `,children:[e(q1,{...a}),t&&e(b,{children:t})]})})}function B2({color:n}){return e("span",{css:m`
        background-color: ${n};
        display: inline-block;
        width: 0.6rem;
        height: 0.6rem;
        border-radius: 2px;
      `})}const Z2=n=>p.useMemo(()=>{const a=n.charCodeAt(0);return Z1(a%26/26)},[n]);function $2({annotationName:n}){const t=Z2(n);return e(B2,{color:t})}const G2=m`
...
`,U2=(n,t)=>{switch(t){case"label":return n.label||typeof n.score=="number"&&Le(n.score)||"n/a";case"score":return typeof n.score=="number"&&Le(n.score)||n.label||"n/a";default:A()}};function D0({annotation:n,onClick:t,annotationDisplayPreference:a="score"}){const i=typeof t=="function",r=U2(n,a);return e("div",{role:i?"button":void 0,css:m(G2,i&&"cursor: pointer;"),"aria-label":i?"Click to view the annotation trace":`Annotation: ${n.name}`,onClick:l=>{l.stopPropagation(),l.preventDefault(),t&&t()},children:o(D,{direction:"row",gap:"size-100",alignItems:"center",children:[e($2,{annotationName:n.name}),e("div",{css:R1,children:e(b,{weight:"heavy",textSize:"small",color:"inherit",children:n.name})}),e("div",{css:m(R1,m`
  ...
  overflow: hidden;
  text-overflow: ellipsis;
`;function Dn(n){const{node:t,selectedSpanNodeId:a,onSpanClick:i,nestingLevel:r=0}=n,l=t.children,[s,d]=p.useState(!1),{isCollapsed:c}=En(),u=l.length>0,g=se(x=>x.showMetricsInTraceTree);p.useEffect(()=>{d(c)},[c]);const{name:h,latencyMs:f,statusCode:L,tokenCountTotal:C,tokenCountPrompt:w,tokenCountCompletion:O}=t.span;return o("div",{children:[e("button",{className:"button--reset",css:m`
          width: 100%;
          min-width: 200px;
          cursor: pointer;
        `,onClick:()=>{p.startTransition(()=>{i&&i(t.span)})},children:o(ki,{isSelected:a===t.span.id,nestingLevel:r,children:[o(D,{direction:"row",gap:"size-100",justifyContent:"start",alignItems:"center",flex:"1 1 auto",minWidth:0,children:[e(Li,{spanKind:t.span.spanKind}),e("span",{css:yi,title:h,children:h}),L==="ERROR"?e(q2,{statusCode:"ERROR"}):null,typeof C=="number"&&g?e(W2,{tokenCountTotal:C,tokenCountPrompt:w??0,tokenCountCompletion:O??0}):null,f!=null&&g?e(j2,{latencyMs:f,showIcon:!1}):null]}),e("div",{css:Si,"data-testid":"span-controls",children:u?e(Ti,{isCollapsed:s,onClick:()=>{d(!s)}}):null})]})}),l.length?e("ul",{css:m`
            display: ${s?"none":"flex"};
            flex-direction: column;
          `,children:l.map((x,F)=>{const te=l[F+1];return o("li",{css:m`
                  position: relative;
                `,children:[te?e(wi,{...te.span,nestingLevel:r}):null,e(xi,{...x.span,nestingLevel:r}),e(Dn,{node:x,onSpanClick:i,selectedSpanNodeId:a,nestingLevel:r+1})]},x.span.context.spanId)})}):null]})}function ki(n){return e("div",{className:n.isSelected?"is-selected":"",css:m`
        width: 100%;
        display: flex;
        flex-direction: row;
        justify-content: space-between;
        ...
        & > *:first-child {
          margin-left: ${n.nestingLevel*m1+16}px;
        }
      `,children:n.children})}function wi({statusCode:n,nestingLevel:t}){return e("div",{"aria-hidden":"true","data-testid":"span-tree-edge-connector",css:a=>m`
        position: absolute;
        ...
        bottom: 0;
        z-index: 1;
      `})}function xi({nestingLevel:n,statusCode:t}){return e("div",{"aria-hidden":"true",css:a=>{const i=t==="ERROR"?a.colors.statusDanger:"var(--ac-global-color-grey-700)";return m`
          position: absolute;
...
`;function Ti({isCollapsed:n,onClick:t}){return e("button",{onClick:a=>{a.stopPropagation(),a.preventDefault(),t()},className:G1("button--reset",{"is-collapsed":n}),css:Mi,children:e(E,{svg:e(S.ArrowIosDownwardOutline,{})})})}class F0 extends Y.Component{constructor(t){super(t),this.state={hasError:!1,error:null}}static getDerivedStateFromError(t){return{hasError:!0,error:t}}componentDidCatch(t,a){}render(){return this.state.hasError?e(y,{padding:"size-200",children:o(D,{direction:"column",children:[o(D,{direction:"column",width:"100%",alignItems:"center",children:[e(q1,{graphicKey:"error"}),e("h1",{children:"Something went wrong"})]}),e("p",{children:"We strive to do our very best but 🐛 bugs happen. It would mean a lot to us if you could file a an issue. If you feel comfortable, please include the error details below in your issue. We will get back to you as soon as we can."}),e(D,{direction:"row",width:"100%",justifyContent:"end",children:e(P,{href:"https://github.com/Arize-ai/phoenix/issues/new?assignees=&labels=bug&template=bug_report.md&title=%5BBUG%5D",children:"file an issue with us"})}),o("details",{open:!0,children:[e("summary",{children:"error details"}),e("pre",{css:m`
                  white-space: pre-wrap;
                  overflow-wrap: break-word;
                  overflow: hidden;
                  overflow-y: auto;
                  max-height: 500px;
                `,children:this.state.error instanceof Error?this.state.error.message:null})]})]})}):this.props.children}}const Vn=p.createContext(null);function _n(){let n=p.useContext(Vn);return n===null&&(console.warn("useMarkdownMode must be used within a MarkdownDisplayProvider"),n={mode:"text",setMode:()=>{}}),n}function N0(n){const t=se(r=>r.markdownDisplayMode),a=se(r=>r.setMarkdownDisplayMode),i=p.useCallback(r=>{p.startTransition(()=>{a(r)})},[a]);return e(Vn.Provider,{value:{mode:t,setMode:i},children:n.children})}const Ii=m`
  a {
    color: var(--ac-global-color-primary);
    &:visited {
...
`;function Ei({children:n,mode:t}){return t==="markdown"?e("div",{css:Ii,children:e(ft,{remarkPlugins:[Lt],children:n})}):e("pre",{css:m`
        white-space: pre-wrap;
        text-wrap: wrap;
        margin: 0;
      `,children:n})}function P0({children:n}){const{mode:t}=_n();return e(Ei,{mode:t,children:n})}function Di({mode:n,onModeChange:t}){return o(Me,{size:"compact",variant:"inline-button",value:n,onChange:a=>{t(a)},children:[e(Z,{label:"text",value:"text",children:o(R,{placement:"top",delay:1e3,offset:10,children:[e(X,{children:e(E,{svg:e(Vt,{})})}),e(j,{children:"Text"})]})}),e(Z,{label:"markdown",value:"markdown",children:o(R,{placement:"top",delay:1e3,offset:10,children:[e(X,{children:e(E,{svg:e(_t,{})})}),e(j,{children:"Markdown"})]})})]})}function A0(){const{mode:n,setMode:t}=_n();return e(Di,{mode:n,onModeChange:t})}function O0(n){const{spanKind:t}=n,a=p.useMemo(()=>{let i="grey-500";switch(t){case"llm":i="orange-1000";break;case"chain":i="blue-1000";break;case"retriever":i="seafoam-1000";break;case"reranker":i="celery-1000";break;case"embedding":i="indigo-1000";break;case"agent":i="grey-900";break;case"tool":i="yellow-1200";break;case"evaluator":i="indigo-1200";break;case"guardrail":i="fuchsia-1200";break}return i},[t]);return e(i1,{color:a,children:t})}function Vi(n){const{theme:t}=U(),a=t==="light"?void 0:He;return e(Re,{value:n.value,extensions:[W1(),J1.lineWrapping,X1(Y1())],editable:!0,theme:a,...n})}const p1=m`
  .cm-content {
...
`;function z0(n){const{theme:t}=U(),a=t==="light"?void 0:He;return e(Re,{value:n.value,extensions:[W1(),J1.lineWrapping,X1(Y1())],editable:!1,theme:a,...n,basicSetup:{lineNumbers:!0,foldGutter:!0,bracketMatching:!0,syntaxHighlighting:!0,highlightActiveLine:!1,highlightActiveLineGutter:!1},css:p1})}function _i(n){const{theme:t}=U(),a=t==="light"?void 0:He;return e(Re,{value:n.value,extensions:[Ht()],editable:!1,theme:a,...n,basicSetup:{lineNumbers:!1,foldGutter:!0,bracketMatching:!0,syntaxHighlighting:!0,highlightActiveLine:!1,highlightActiveLineGutter:!1},css:p1})}function W(n){const{value:t}=n;return o("div",{className:"python-code-block",css:Fn,children:[e(xn,{text:t}),e(_i,{value:t})]})}function Q({children:n}){return e(y,{borderColor:"light",borderWidth:"thin",borderRadius:"small",children:n})}function Fi(n){const{theme:t}=U(),a=t==="light"?void 0:He;return e(Re,{value:n.value,extensions:[Kt({typescript:!0})],editable:!1,theme:a,...n,basicSetup:{lineNumbers:!1,foldGutter:!0,bracketMatching:!0,syntaxHighlighting:!0,highlightActiveLine:!1,highlightActiveLineGutter:!1},css:p1})}const Ni=m`
  &.is-hovered {
  ...
  border-radius: ${Q1.borderRadius.medium}px;
...
`;function h1({docsHref:n,githubHref:t,icon:a,name:i}){return o("div",{css:Ji,children:[o("a",{href:n,className:"integration__main-link",target:"_blank",rel:"noreferrer",children:[a,i]}),e("div",{children:e("a",{href:t,target:"_blank",rel:"noreferrer",className:"integration__github-link","aria-label":"GitHub link",children:e(ir,{})})})]})}const Xi=[{name:"OpenAI",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/openai",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-openai",icon:e(zn,{})},{name:"LlamaIndex",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-llama-index",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/llamaindex",icon:e(Ki,{})},{name:"LangChain",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/langchain",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-langchain",icon:e(Rn,{})},{name:"Haystack",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/haystack",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-haystack",icon:e(Bi,{})},{name:"Vertex AI",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/vertex",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-vertexai",icon:e($i,{})},{name:"Mistral AI",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/mistralai",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-mistralai",icon:e(Zi,{})},{name:"DSPy",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/dspy",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-dspy",icon:e(Gi,{})},{name:"Anthropic",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/anthropic",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-anthropic",icon:e(Ui,{})},{name:"Bedrock",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/bedrock",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-bedrock",icon:e(Wi,{})},{name:"Groq",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/groq",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-groq",icon:e(ji,{})},{name:"CrewAI",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/crewai",githubHref:"https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-crewai",icon:e(Qi,{})}],g1=m`
  width: 100%;
  display: flex;
  flex-direction: row;
  gap: var(--ac-global-dimension-size-100);
  flex-wrap: wrap;
`;function Yi(){return e("ul",{css:g1,children:Xi.map(n=>e("li",{children:e(h1,{...n},n.name)},n.name))})}const er=[{name:"Node",docsHref:"https://opentelemetry.io/docs/languages/js/getting-started/nodejs/",githubHref:"https://github.com/open-telemetry/opentelemetry-js",icon:e(qi,{})},{name:"Vercel",docsHref:"https://vercel.com/docs/observability/otel-overview",githubHref:"https://github.com/vercel/otel",icon:e(Hn,{})}];function nr(){return e("ul",{css:g1,children:er.map(n=>e("li",{children:e(h1,{...n},n.name)},n.name))})}const tr=[{name:"OpenAI NodeJS SDK",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/openai-node-sdk",githubHref:"https://github.com/Arize-ai/openinference/tree/main/js/packages/openinference-vercel",icon:e(zn,{})},{name:"LangChain.js",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/langchain.js",githubHref:"https://github.com/Arize-ai/openinference/tree/main/js/packages/openinference-instrumentation-langchain",icon:e(Rn,{})},{name:"Vercel AI SDK",docsHref:"https://docs.arize.com/phoenix/tracing/integrations-tracing/vercel-ai-sdk",githubHref:"https://github.com/Arize-ai/openinference/tree/main/js/packages/openinference-vercel",icon:e(Hn,{})}];function ar(){return e("ul",{css:g1,children:tr.map(n=>e("li",{children:e(h1,{...n},n.name)},n.name))})}const ir=()=>e("svg",{xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",children:o("g",{"data-name":"Layer 2",children:[e("rect",{width:"24",height:"24",transform:"rotate(180 12 12)",opacity:"0"}),e("path",{d:"M12 1A10.89 10.89 0 0 0 1 11.77 10.79 10.79 0 0 0 8.52 22c.55.1.75-.23.75-.52v-1.83c-3.06.65-3.71-1.44-3.71-1.44a2.86 2.86 0 0 0-1.22-1.58c-1-.66.08-.65.08-.65a2.31 2.31 0 0 1 1.68 1.11 2.37 2.37 0 0 0 3.2.89 2.33 2.33 0 0 1 .7-1.44c-2.44-.27-5-1.19-5-5.32a4.15 4.15 0 0 1 1.11-2.91 3.78 3.78 0 0 1 .11-2.84s.93-.29 3 1.1a10.68 10.68 0 0 1 5.5 0c2.1-1.39 3-1.1 3-1.1a3.78 3.78 0 0 1 .11 2.84A4.15 4.15 0 0 1 19 11.2c0 4.14-2.58 5.05-5 5.32a2.5 2.5 0 0 1 .75 2v2.95c0 .35.2.63.75.52A10.8 10.8 0 0 0 23 11.77 10.89 10.89 0 0 0 12 1","data-name":"github",fill:"currentColor"})]})}),rr="https://docs.arize.com/phoenix/tracing/how-to-tracing/setup-tracing",lr="https://docs.arize.com/phoenix/tracing/how-to-tracing/setup-tracing/setup-tracing-python/using-otel-python-directly",or="https://docs.arize.com/phoenix/setup/configuration",sr="pip install arize-phoenix-otel",cr="pip install openinference-instrumentation-openai openai",f1="https://app.phoenix.arize.com",dr="https://llamatrace.com",ur=[f1,dr],mr=`PHOENIX_CLIENT_HEADERS='api_key=<your-api-key>'
PHOENIX_COLLECTOR_ENDPOINT='${f1}'`,pr=`from openinference.instrumentation.openai import OpenAIInstrumentor

OpenAIInstrumentor().instrument(tracer_provider=tracer_provider)`,hr=`import os
...
chat_completion = client.chat.completions.create(
    ...
    model="gpt-3.5-turbo",
)`,gr=({isHosted:n,projectName:t})=>`from phoenix.otel import register

tracer_provider = register(
  project_name="${t}",
  endpoint="${(n?f1:o1)+"/v1/traces"}"
)`;function G0(n){const t=ur.includes(o1),a=n.projectName||"your-next-llm-project";return o("div",{children:[e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Install Dependencies"})}),e(y,{paddingBottom:"size-100",children:o(b,{children:["Use the Phoenix OTEL or"," ",e(P,{href:lr,children:"OpenTelemetry"})," to configure your application to send traces to Phoenix."]})}),e(Q,{children:e(W,{value:sr})}),e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Setup your Environment"})}),e(y,{paddingBottom:"size-100",children:o(b,{children:[e("b",{children:"arize-phoenix-otel"})," automatically picks up your configuration from environment variables (e.x. ",e("b",{children:"PHOENIX_CLIENT_HEADERS"})," for authentication). See"," ",e(P,{href:or,children:"environment variables"})]})}),t?e(Q,{children:e(W,{value:mr})}):null,e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Setup OpenTelemetry"})}),e(y,{paddingBottom:"size-100",children:o(b,{children:["Register your application to send traces to this project. The code below should be added ",e("b",{children:"BEFORE"})," any code execution."]})}),e(y,{paddingBottom:"size-100",children:e(Q,{children:e(W,{value:gr({projectName:a,isHosted:t})})})}),t?null:e(y,{paddingBottom:"size-100",children:o(b,{children:["To configure gRPC and batching, see our"," ",e(P,{href:rr,children:"setup guide"}),"."]})}),e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Setup Instrumentation"})}),e(y,{paddingBottom:"size-100",children:e(b,{children:"Add instrumentation to your application so that your application code is traces."})}),e(At,{variant:"compact",children:o(Pt,{children:[e(b1,{name:"Instrumentation",children:o(y,{padding:"size-200",children:[o(b,{children:["Trace your application using"," ",e(P,{href:"https://github.com/Arize-ai/openinference",children:"OpenInference"})," ","instrumentation and OpenTelemetry"]}),e(y,{paddingTop:"size-200",paddingBottom:"size-200",children:e(Yi,{})}),o(b,{children:["For more integrations, checkout our"," ",e(P,{href:"https://docs.arize.com/phoenix/tracing/integrations-tracing",children:"comprehensive guide"})]})]})}),e(b1,{name:"OpenAI Example",children:o(y,{padding:"size-200",children:[o("p",{children:["Install"," ",e(P,{href:"https://github.com/Arize-ai/openinference",children:"OpenInference"})," ","instrumentation as well as ",e("b",{children:"openai"})]}),e(Q,{children:e(W,{value:cr})}),o("p",{children:["Instrument ",e("b",{children:"openai"})," at the beginning of your code"]}),e(y,{paddingBottom:"size-50",children:e(Q,{children:e(W,{value:pr})})}),o("p",{children:["Use ",e("b",{children:"openai"})," as you normally and traces will be sent to Phoenix"]}),e(y,{paddingBottom:"size-50",children:e(Q,{children:e(W,{value:hr})})})]})})]})})]})}function fr(n){const{value:t}=n;return o("div",{className:"typescript-code-block",css:Fn,children:[e(xn,{text:t}),e(Fi,{value:t})]})}const Lr="https://docs.arize.com/phoenix/tracing/how-to-tracing/setup-tracing",Cr=n=>`import { Resource } from '@opentelemetry/resources';
import { SEMRESATTRS_PROJECT_NAME } from '@arizeai/openinference-semantic-conventions';

resource: new Resource({
    [SEMRESATTRS_PROJECT_NAME]: "${n}",
});`;function U0(n){const a=n.projectName||"your-next-llm-project";return o("div",{children:[e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Setup OpenTelemetry"})}),e(y,{paddingBottom:"size-100",children:o(b,{children:["Configure"," ",e(P,{href:Lr,children:"OpenTelemetry"})," ","to send traces to Phoenix."]})}),e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(nr,{})}),e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Setup your Environment"})}),e(y,{paddingBottom:"size-100",children:o(b,{children:["If authentication is enabled, set the"," ",e("b",{children:"OTEL_EXPORTER_OTLP_TRACES_HEADERS"}),". See"," ",e(P,{href:"https://opentelemetry.io/docs/languages/sdk-configuration/otlp-exporter/#otel_exporter_otlp_traces_headers",children:"environment variable"})]})}),e(Q,{children:e(W,{value:"OTEL_EXPORTER_OTLP_TRACES_HEADERS='<auth-headers>'"})}),e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Set the Project Name"})}),e(y,{paddingBottom:"size-100",children:o(b,{children:["Set the project name for your app in the ",e("b",{children:"Resource Attributes"}),"."]})}),e(y,{paddingBottom:"size-100",children:e(Q,{children:e(W,{value:"npm install @arizeai/openinference-semantic-conventions --save"})})}),e(y,{paddingBottom:"size-100",children:e(Q,{children:e(fr,{value:Cr(a)})})}),e(y,{paddingBottom:"size-100",children:o(b,{children:["Add the resources to the NodeJS SDK or Vercel OTEL registration. See"," ",e(P,{href:"https://opentelemetry.io/docs/languages/js/resources/",children:"resources"})," ","for details."]})}),e(y,{paddingTop:"size-200",paddingBottom:"size-100",children:e(V,{level:2,weight:"heavy",children:"Setup Instrumentation"})}),e(y,{paddingBottom:"size-100",children:e(b,{children:"Add instrumentation to your application so that your application code is traces."})}),e(y,{paddingBottom:"size-100",children:e(ar,{})})]})}function j0(n){return e("button",{className:"button--reset",onClick:t=>{t.stopPropagation(),n.onClick(t)},"aria-label":n["aria-label"],css:m`
      ...
      `,children:e(E,{svg:n.isExpanded?e(S.ChevronDownOutline,{}):e(S.ChevronRightOutline,{})})})}function vr(n){const{size:t=28}=n;return o("svg",{xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 305.92 350.13",width:t,height:t,css:m`
        .cls-1 {
...
`,wr=()=>e("svg",{xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",children:o("g",{"data-name":"Layer 2",children:[e("rect",{width:"24",height:"24",transform:"rotate(180 12 12)",opacity:"0"}),e("path",{d:"M12 1A10.89 10.89 0 0 0 1 11.77 10.79 10.79 0 0 0 8.52 22c.55.1.75-.23.75-.52v-1.83c-3.06.65-3.71-1.44-3.71-1.44a2.86 2.86 0 0 0-1.22-1.58c-1-.66.08-.65.08-.65a2.31 2.31 0 0 1 1.68 1.11 2.37 2.37 0 0 0 3.2.89 2.33 2.33 0 0 1 .7-1.44c-2.44-.27-5-1.19-5-5.32a4.15 4.15 0 0 1 1.11-2.91 3.78 3.78 0 0 1 .11-2.84s.93-.29 3 1.1a10.68 10.68 0 0 1 5.5 0c2.1-1.39 3-1.1 3-1.1a3.78 3.78 0 0 1 .11 2.84A4.15 4.15 0 0 1 19 11.2c0 4.14-2.58 5.05-5 5.32a2.5 2.5 0 0 1 .75 2v2.95c0 .35.2.63.75.52A10.8 10.8 0 0 0 23 11.77 10.89 10.89 0 0 0 12 1","data-name":"github"})]})});function Kn(n){return o("a",{href:n.href,target:"_blank",css:L1,rel:"noreferrer",children:[n.icon,e(b,{children:n.text})]})}function Q0(){return e(Kn,{href:"https://github.com/arize-ai/phoenix",icon:e(E,{svg:e(wr,{})}),text:"Repository"})}function q0(){return e(Kn,{href:"https://docs.arize.com/phoenix",icon:e(E,{svg:e(S.BookOutline,{})}),text:"Documentation"})}function W0(){const{theme:n,setTheme:t}=U(),a=n==="dark";return o("button",{css:L1,onClick:()=>t(a?"light":"dark"),className:"button--reset",children:[e(E,{svg:a?e(S.MoonOutline,{}):e(S.SunOutline,{})}),e(b,{children:a?"Dark":"Light"})]})}function J0(){return e(B1,{to:"/",css:kr,title:`version: ${window.Config.platformVersion}`,children:e(vr,{})})}function X0({children:n}){return e("nav",{css:br,children:n})}function Y0({children:n}){const[t,a]=p.useState(!1);return e("nav",{"data-expanded":t,css:yr,onMouseOver:()=>{a(!0)},onMouseOut:()=>{a(!1)},children:n})}function el(n){return o(vt,{to:n.to,css:L1,children:[n.icon,e(b,{children:n.text})]})}function xr(n){var t;return typeof n.handle=="object"&&typeof((t=n.handle)==null?void 0:t.crumb)=="function"}function nl(){const n=bt(),a=yt().filter(xr);return e(Ot,{onAction:i=>{n(a[Number(i)].pathname)},children:a.map((i,r)=>e(N,{children:i.handle.crumb(i.data)},r))})}const Sr=24*60*60*1e3,tl=30*Sr,Bn=function(){var n={defaultValue:null,kind:"LocalArgument",name:"datasetId"},t={defaultValue:null,kind:"LocalArgument",name:"description"},a={defaultValue:null,kind:"LocalArgument",name:"metadata"},i={defaultValue:null,kind:"LocalArgument",name:"name"},r=[{alias:null,args:[{fields:[{kind:"Variable",name:"datasetId",variableName:"datasetId"},{kind:"Variable",name:"description",variableName:"description"},{kind:"Variable",name:"metadata",variableName:"metadata"},{kind:"Variable",name:"name",variableName:"name"}],kind:"ObjectValue",name:"input"}],concreteType:"DatasetMutationPayload",kind:"LinkedField",name:"patchDataset",plural:!1,selections:[{alias:null,args:null,concreteType:"Dataset",kind:"LinkedField",name:"dataset",plural:!1,selections:[{alias:null,args:null,kind:"ScalarField",name:"name",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"description",storageKey:null},{alias:null,args:null,kind:"ScalarField",name:"metadata",storageKey:null}],storageKey:null}],storageKey:null}];return{fragment:{argumentDefinitions:[n,t,a,i],kind:"Fragment",metadata:null,name:"EditDatasetFormMutation",selections:r,type:"Mutation",abstractKey:null},kind:"Request",operation:{argumentDefinitions:[n,i,t,a],kind:"Operation",name:"EditDatasetFormMutation",selections:r},params:{cacheID:"d68da97aac0aaababba2324b7d10e250",id:null,metadata:{},name:"EditDatasetFormMutation",operationKind:"mutation",text:`mutation EditDatasetFormMutation(
  $datasetId: GlobalID!
  $name: String!
  $description: String = null
  $metadata: JSON = null
...
`}}}();Bn.hash="17e232f5c22d36d0663f140c00343680";function al({datasetName:n,datasetId:t,datasetDescription:a,onDatasetEdited:i,onDatasetEditError:r,datasetMetadata:l}){const[s,d]=q.useMutation(Bn);return e(Pn,{datasetName:n,datasetDescription:a,datasetMetadata:l,onSubmit:u=>{s({variables:{datasetId:t,...u,metadata:JSON.parse(u.metadata)},onCompleted:()=>{i()},onError:g=>{r(g)}})},isSubmitting:d,submitButtonText:d?"Saving...":"Save",formMode:"edit"})}function il({sequenceNumber:n}){return o(i1,{color:"yellow-1000",children:["#",n]})}var Ze=(n=>(n.ADMIN="ADMIN",n.MEMBER="MEMBER",n))(Ze||{});const Mr=Object.values(Ze);function Tr(n){return typeof n=="string"&&n in Ze}function Ir({onChange:n,role:t,...a}){return e(Se,{label:"Role",className:"role-picker",defaultSelectedKey:t,"aria-label":"User Role",onSelectionChange:i=>{Tr(i)&&n(i)},width:"100%",...a,children:Mr.map(i=>e(N,{children:i.toLocaleLowerCase()},i))})}const H1=4;function rl({onSubmit:n,email:t,username:a,password:i,role:r,isSubmitting:l}){const{control:s,handleSubmit:d,formState:{isDirty:c}}=ze({defaultValues:{email:t??"",username:a??null,password:i??"",role:r??Ze.MEMBER}});return e("div",{css:m`
        .role-picker {
          width: 100%;
          .ac-dropdown--picker,
          .ac-dropdown-button {
      ...
      `,children:o(Te,{onSubmit:d(n),children:[o(y,{padding:"size-200",children:[e(z,{name:"email",control:s,rules:{required:"Email is required",pattern:{value:/^[^@\s]+@[^@\s]+[.][^@\s]+$/,message:"Invalid email format"}},render:({field:{name:u,onChange:g,onBlur:h,value:f},fieldState:{invalid:L,error:C}})=>e(B,{label:"Email",type:"email",name:u,isRequired:!0,description:"The user's email address. Must be unique.",errorMessage:C==null?void 0:C.message,validationState:L?"invalid":"valid",onChange:g,onBlur:h,value:f})}),e(z,{name:"username",control:s,render:({field:{name:u,onChange:g,onBlur:h,value:f},fieldState:{invalid:L,error:C}})=>e(B,{label:"Username",name:u,description:"The user's username. Optional.",errorMessage:C==null?void 0:C.message,validationState:L?"invalid":"valid",onChange:g,onBlur:h,value:f==null?void 0:f.toString()})}),e(z,{name:"password",control:s,rules:{required:"Password is required",minLength:{value:H1,message:`Password must be at least ${H1} characters`}},render:({field:{name:u,onChange:g,onBlur:h,value:f},fieldState:{invalid:L,error:C}})=>e(B,{label:"Password",type:"password",description:"Password must be at least 4 characters",name:u,errorMessage:C==null?void 0:C.message,validationState:L?"invalid":"valid",onChange:g,onBlur:h,defaultValue:f})}),e(z,{name:"role",control:s,render:({field:{onChange:u,value:g},fieldState:{invalid:h,error:f}})=>e(Ir,{onChange:u,role:g,validationState:h?"invalid":"valid",errorMessage:f==null?void 0:f.message})})]}),e(y,{paddingStart:"size-200",paddingEnd:"size-200",paddingTop:"size-100",paddingBottom:"size-100",borderColor:"dark",borderTopWidth:"thin",children:e(D,{direction:"row",gap:"size-100",justifyContent:"end",children:e(G,{variant:c?"primary":"default",type:"submit",size:"compact",disabled:l,children:l?"Adding...":"Add User"})})})]})})}export{p0 as $,P as A,Yr as B,C0 as C,Yt as D,E0 as E,ke as F,Mn as G,ge as H,I0 as I,u0 as J,c1 as K,Ma as L,l0 as M,m0 as N,h0 as O,qr as P,Hr as Q,Ie as R,oe as S,Qr as T,Rr as U,Kr as V,Br as W,o0 as X,g0 as Y,i0 as Z,d0 as _,ua as a,o1 as a$,f0 as a0,c0 as a1,fa as a2,k0 as a3,T0 as a4,yn as a5,La as a6,r0 as a7,Le as a8,G2 as a9,s0 as aA,R0 as aB,G0 as aC,U0 as aD,Gr as aE,Xr as aF,Z0 as aG,Ln as aH,$0 as aI,vi as aJ,j0 as aK,B0 as aL,nl as aM,X0 as aN,J0 as aO,el as aP,q0 as aQ,Q0 as aR,W0 as aS,Y0 as aT,Zr as aU,Or as aV,K0 as aW,tl as aX,al as aY,n0 as aZ,W as a_,B2 as aa,Ur as ab,Q2 as ac,q2 as ad,j2 as ae,W2 as af,D0 as ag,xn as ah,ha as ai,e0 as aj,H0 as ak,Oi as al,Vi as am,se as an,O0 as ao,F0 as ap,Ar as aq,Li as ar,N0 as as,A0 as at,P0 as au,_0 as av,V0 as aw,Ri as ax,Z2 as ay,ga as az,Wr as b,Q as b0,z0 as b1,$2 as b2,il as b3,va as b4,wa as b5,Jr as b6,rl as b7,zr as b8,jr as b9,Pr as ba,$r as bb,t0 as c,U as d,Xt as e,v as f,mn as g,A as h,Ia as i,w0 as j,x0 as k,S0 as l,b0 as m,y0 as n,M0 as o,e1 as p,v0 as q,L0 as r,V1 as s,Cn as t,Ke as u,$a as v,Ga as w,ln as x,Ja as y,a0 as z};
